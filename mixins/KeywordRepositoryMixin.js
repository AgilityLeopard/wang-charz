  ...
  data() {
    const keywordRepository = [
      ...
      },
      {
        ...
        type: "Species",
        parentKeyword: undefined,
        description: "The Ratling abhuman.",
      },
      {
        name: "Ogryn",
        type: "Species",
        parentKeyword: undefined,
        description: "The Ogryn abhuman.",
      },
      {
        name: "Kroot",
        type: "Species",
      ...
      },
      {
        ...
        type: "Species",
        parentKeyword: undefined,
        description: "The Eldar race.",
      },
      {
        name: "Anhrathe",
        type: "Species",
        parentKeyword: undefined,
        description: "Eldar Corsairs, spacefaring pirates and raiders.",
      },
      {
        name: "[Coterie]",
        type: "Species",
        parentKeyword: "Anhrathe",
        description:
          "A specific Eldar Corsair band (replaces this keyword when chosen).",
      },
      {
        name: "Asuryani",
        type: "Species",
        parentKeyword: undefined,
        description: "Eldar of the Craftworlds.",
      },
      {
        name: "[Craftworld]",
        type: "Species",
        parentKeyword: "Asuryani",
        description:
          "A specific Eldar Craftworld (replaces this keyword when chosen).",
      },
      {
        source: "aaoa",
        name: "Drukhari",
      ...
      },
      {
        ...
        type: "Species",
        description:
          "A specific Drukhari Witch Cult (replaces this keyword when chosen).",
      },
      {
        source: "aaoa",
        name: "[Masque]",
        type: "Species",
        description:
          "A specific Harlequin Masque (replaces this keyword when chosen).",
      },
      {
        source: "aaoa",
        name: "[Coven]",
        type: "Species",
        description:
          "A specific Drukhari Haemunculus Coven (replaces this keyword when chosen).",
      },
      {
        source: "aaoa",
        name: "[Cabal]",
        type: "Species",
        description:
          "A specific Drukhari Cabal (replaces this keyword when chosen).",
      },
      {
        name: "Ork",
        type: "Species",
        parentKeyword: undefined,
        description: "The Ork race.",
      },
      {
        name: "[Clan]",
        type: "Species",
        parentKeyword: "Ork",
        description: "A specific Ork clan (replaces this keyword when chosen).",
      },
      {
        source: "aaoa",
        name: "[League]",
        ...
        parentKeyword: "Squat",
        description:
          "A specific Squat league (replaces this keyword when chosen).",
      },
      ...
      // Imperium Keywords
      {
        ...
        type: "Imperium",
        parentKeyword: undefined,
        description: "The Sisters of Battle, warriors of the Ecclesiarchy.",
      },
      {
        name: "[Order]",
        type: "Imperium",
        parentKeyword: "Adepta Sororitas",
        description:
          "A specific Adepta Sororitas Order (replaces this keyword when chosen).",
      },
      {
        name: "[Enclave]",
        type: "Imperium",
        parentKeyword: undefined,
        description:
          "A specific Sisters of Silence Enclave (replaces this keyword when chosen).",
        source: "tnh",
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "The Space Marines, superhuman elite warriors of the Imperium.",
      },
      {
        name: "[Chapter]",
        type: "Imperium",
      ...
      },
      {
        ...
        type: "Imperium",
        parentKeyword: undefined,
        description: "They administrate the role of psykers in the Imperium.",
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "The Tech-Priesthood of Mars, they are entrusted with the secrets of tech-nology; allied to the Imperium.",
        // Data is Currency
        effectLabel: "Data is Currency",
        effect:
          "Characters with the Adeptus Mechanicus keyword may use Intellect in place of Fellowship when calculating Influence.",
      },
      {
        name: "[Forge World]",
        type: "Imperium",
        parentKeyword: "Adeptus Mechanicus",
        description:
          "A specific Adeptus Mechanicus Forge World (replaces this keyword when chosen).",
      },
      {
        name: "Adeptus Ministorum",
        type: "Imperium",
        parentKeyword: undefined,
        description: "Those who preach the Imperial Creed.",
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "The Imperial Guard, soldiers of the Imperium’s main ground forces.",
      },
      {
        name: "[Regiment]",
        type: "Imperium",
        parentKeyword: "Astra Militarum",
        description:
          "A specific Astra Militarum Regiment (replaces this keyword when chosen).",
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "The Priesthood of the Omnissiah, a subset of the Adeptus Mechanicus.",
      },
      {
        name: "Imperium",
        type: "Imperium",
        parentKeyword: undefined,
        description:
          "The Imperium of Man, a galaxy-spanning civilisation 10,000 years old.",
      },
      {
        name: "Inquisition",
        type: "Imperium",
        parentKeyword: undefined,
        description:
          "Investigators and questioners, they wield great authority to root out threats to the Imperium.",
      },
      {
        name: "[Ordo]",
        type: "Imperium",
        parentKeyword: "Inquisition",
        description:
          "A specific Ordo of the Inquisition (replaces this keyword when chosen).",
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "Elite, specially-trained and equipped soldiers of the Astra Militarum.",
      },
      {
      ...
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "Elite leaders and disciplinarians of the Imperium’s military.",
      },
      {
        name: "Primaris",
        type: "Imperium",
        parentKeyword: undefined,
        description: "A new, improved breed of Space Marine.",
      },
      {
        name: "Rogue Trader",
        type: "Imperium",
        parentKeyword: undefined,
        description:
          "Space-faring merchant princes and explorers, granted great authority to expand the Imperium’s borders.",
      },
      {
        name: "[Dynasty]",
        type: "Imperium",
        parentKeyword: "Rogue Trader",
        description:
          "A specific Rogue Trader Dynasty (replaces this keyword when chosen).",
      },
      {
        name: "Adeptus Astra Telepathica",
        type: "Imperium",
        parentKeyword: undefined,
        description:
          "This Organisation is responsible for the recruitment and training of psykers.",
      },
      {
        name: "Scholastica Psykana",
        type: "Imperium",
        parentKeyword: undefined,
        description:
          "A subset of the Adeptus Astra Telepathica, they train psykers in the use of their powers.",
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "A subset of the Adeptus Astra Telepathica, they train the Psychic Blanks into the Sisters of Silence.",
        source: "tnh",
      },
      {
        name: "Scum",
        ...
        parentKeyword: undefined,
        description:
          "Those who live upon the fringes of Imperial society, often in the underhive or criminal syndicates.",
      },
      {
        name: "Skitarii",
        type: "Imperium",
        parentKeyword: undefined,
        description:
          "The warriors of the Omnissiah, devout troops who wield ancient technology.",
      },
      {
        name: "Navis Nobilite",
        type: "Imperium",
        parentKeyword: undefined,
        description:
          "The mutants whose abilities allow starships to pass through the warp and so travel between distant stars.",
        source: "pax",
        // Data is Currency
        effectLabel: "Nobilite Encoding",
        effect:
          "A number of archaic, dead tongues or dialects, now only know to the ancient Nobilite families that keep the old languages alive. A Navis Nobilite House character may choose this language as one of his initial languages, or purchase it for 1 XP at a later time.",
      },
      {
        name: "[Navis House]",
        type: "Imperium",
      ...
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "Those unfortunate few whose very presence is unnaturally ‘wrong’, and intrinsically opposed to the Immaterium.",
        source: "pax",
      },
      {
        name: "[Gang]",
...

      {
        ...
        description:
          "A specific type of Arbites precinct (replaces this keyword when chosen).",
        source: "pax",
      },
      ...
      // Renegade and Heretic Keywords
      {
        ...
        type: "Renegade",
        parentKeyword: undefined,
        description: "Those who serve the Dark Gods, knowingly or otherwise.",
      },
      {
        name: "[Mark of Chaos]",
        type: "Renegade",
        parentKeyword: undefined,
        description:
          "A specific Chaos God (replaces this keyword when chosen).",
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "Small groups of Tech-Priests who have rejected the doctrines of Mars and work with the forces of Chaos.",
      },
      {
        name: "Heretic",
        type: "Renegade",
        parentKeyword: undefined,
        description: "Those who have rejected the Imperial Creed.",
      },
      {
        ...
        parentKeyword: undefined,
        description:
          "Once loyal to the imperium but now outlawed and enemies of mankind.",
      },
      {
        name: "[Legion]",
        type: "Renegade",
        parentKeyword: undefined,
        description:
          "A specific Heretic Astartes Legion (replaces this keyword when chosen).",
      },
      ...
      // Social PAX
      {
        ...
        type: "Social",
        parentKeyword: undefined,
        description: "The high born elite of the Imperium.",
      },
      {
        source: "pax",
        name: "Lower Class",
        ...
        parentKeyword: undefined,
        description:
          "Those who in their uncountable numbers toil at industry, agriculture or another manual trade.",
      },
      {
        source: "pax",
        name: "Outcast",
        ...
        parentKeyword: undefined,
        description:
          "Those unfortunates who have slipped through the cracks of society.",
      },
      {
        source: "pax",
        name: "Military",
        type: "Social",
        parentKeyword: undefined,
        description: "Those whose craft is the waging of war.",
      },
    ];
    const keywordSubwordRepository = [
      ...
      // Orders of the Adepta Sororitas
      {
        ...
        type: "Order Militant of the Adepta Sororitas",
        description:
        ...
        effect:
          "When attempting an action associated with your order, the GM may grant you bonus dice.",
      },
      {
        placeholder: "[Order]",
      ...
      {
        placeholder: "[Order]",
        name: "Order of the Valorous Heart",
        type: "Order Militant of the Adepta Sororitas",
        description:
      ...
      {
        placeholder: "[Order]",
        name: "Order of Sacred Rose",
        type: "Order Militant of the Adepta Astartes",
        description:
      ...
      {
        placeholder: "[Order]",
        name: "Order of the Agent Shroud",
        type: "Order Militant of the Adepta Sororitas",
        description:
          "This order is famed for their righteous fury and selfl ess acts of heroism. Their founder seldom spoke, believing that deeds proved more devotion than words.",
        effect:
          "When attempting an action associated with your order, the GM may grant you bonus dice.",
      },
        ...
        modifications: [
          {
            ...
            modifier: 0,
            rank: 1,
            condition: "when repairing a vehicle or weapon",
          },
        ],
      },
      {
        ...
        type: "Regiment of the Astra Militarum",
        description:
          "Though their homeworld was destroyed, the resolute will of the most renowned Regiment of the Astra Militarum refuses to break as long as a single soldier stands.",
        modification: {},
        modifications: [
          {
            targetGroup: "traits",
      ...
      },
      {
        ...
        description:
          "Every firstborn child of Vostroya is offered to the Astra Militarum in atonement for the planet’s past sins. All see this as an honour, continuing to send reinforcements blind through the void despite the perils of Noctis Aeternia.",
        modification: {},
        modifications: [
          {
            targetGroup: "traits",
            targetValue: "determination",
            modifier: 0,
            rank: 1,
          },
        ],
      ...
      // (i) Characters with the [Ordo] keyword must have the Inquisition keyword as well.
      {
        ...
        effect:
          "Choose one: You gain +2 bonus dice to resist psychic powers, or you gain +2 " +
      ...
      },
      {
        ...
        name: "Ordo Xenos",
        description:
          "The Ordo Xenos is tasked with defeating the alien in all its loathsome " +
        ...
        effect:
          "The character is fluent in one alien language; choose an alien species and " +
        ...
        modifications: [
          ...
          },
          {
            ...
            targetValue: "scholar",
            modifier: 2,
            condition: "when related to xenos.",
          },
          {
            targetGroup: "skills",
            targetValue: "investigation",
            modifier: 2,
            condition: "when related to xenos.",
          },
        ],
      },
      {
        ...
        name: "Ordo Malleus",
        description:
          "The Ordo Malleus were established to fight against mankind’s greatest " +
          ...
          "structure.",
        effect:
          "Either the character gains +3 Corruption and +1 Conviction, or gain +2 bonus dice for any " +
        ...
        options: [
          ...
          },
          {
            name: "Ordo Malleus Specialisaton",
            snippet:
              "You gain +2 bonus dice to Scholar (Int) and Investigation (Int) tests related to daemons and the warp.",
            description: "",
            modifications: [
              {
                targetGroup: "skills",
                targetValue: "scholar",
                modifier: 2,
                condition: "when related to daemons and the warp",
              },
              {
                targetGroup: "skills",
                targetValue: "investigation",
      ...
      },
      {
        ...
        name: "Other Ordo",
        description:
          "Inquisitors are as varied in appearance, manner and method as the worlds " +
          "of the Imperium they strive to protect.",
        effect:
          "Choose one Skill from the following list: Cunning, Deception, Insight, " +
      ...
      {
        type: "Forge World of the Adeptus Mechanicus",
        placeholder: "[Forge World]",
        name: "Mars",
        description:
          "The Red Planet: Birthplace of the Cult Mechanicus, considered the holiest of all celestial orbs. Tech-Priests of Mars consider themselves the most blessed of the Cult Mechanicus, and their ability to placate machine spirits is second to none.",
      },
      {
        type: "Forge World of the Adeptus Mechanicus",
        placeholder: "[Forge World]",
        name: "Lucius",
        description:
          "The Hollow Forge: A hollow world, Lucius is powered by an artificial sun in the planet’s core. This Forge World is known for creating a unique, sought-after alloy known as Luciun.",
      },
      {
        type: "Forge World of the Adeptus Mechanicus",
        placeholder: "[Forge World]",
      ...
      },
      {
        ...
        name: "Ryza",
        description:
          "Furnace of Shackled Stars: Famed for producing containment fields and plasma weaponry, Ryza is locked in a battle of survival against the invasion of two major Ork Waaagh!s. The residents of this Forge World have a reputation for fi erceness.",
      },
      {
        type: "Forge World of the Adeptus Mechanicus",
        placeholder: "[Forge World]",
        name: "Triplex / Phall",
        description:
          "Forge of the Eastern Frontier: Isolated on the Eastern Fringe, this Forge World is considered somewhat insubordinate to Mars. Autonomous and independently-minded, Triplex Phall sends numerous explorator fl eets to discover new worlds and resources.",
      },
      {
        type: "Forge World of the Adeptus Mechanicus",
        placeholder: "[Forge World]",
      ...
      },
      {
        ...
        name: "Gryphonne IV",
        description:
          "The Lost Forge: The formidable defences of this Forge World were overrun by the assault of Hive Fleet Leviathan. Certain that their fortifi cations would ensure victory, the defenders fought with valour and skill. However, the Tyranids shattered Gryphonne IV’s armies and laid waste to the world. Only a relative handful of survivors escaped.",
      },
      {
        type: "Forge World of the Adeptus Mechanicus",
        placeholder: "[Forge World]",
        name: "Avachrus",
        description: "(See CORE pg. xx)",
      },

      // Astartes Chapters
      {
        type: "Chapter of the Adeptus Astartes",
        placeholder: "[Chapter]",
        name: "Blood Angels",
        description:
      ...
      },
      {
        ...
        name: "Salamanders",
        description:
          "The Salamanders’ Seed World is the planet Nocturne, a planet of exotic radiation and constant lava fl ows. They are known for their fi erce determination and endurance, which complement their skill at arms. The Salamanders are the only legion that did not divide into other chapters during the Second Founding, due to the severe losses they suffered during the Horus Heresy.",
      },
      {
        type: "Chapter of the Adeptus Astartes",
        placeholder: "[Chapter]",
        name: "Space Wolves",
        description:
          "The Space Wolves are fiercely loyal to the Imperium, but they are a savage and boastful lot. They have no patience for the rules of the Codex Astartes or any other Imperial authority. Instead, they revel in their feral actions and appearance as they overcome any who would dare to oppose the Imperium.",
      },
      {
        type: "Chapter of the Adeptus Astartes",
        placeholder: "[Chapter]",
      ...
      },
      {
        ...
        placeholder: "[Chapter]",
        name: "Other Chapter",
        description: "An unkown chapter in the vast space.",
      },

      //
      {
        source: "dod",
        type: "Chapter House of the Adeptus Astartes",
        placeholder: "[Chapter]",
        name: "Shadow Tales (House Isenwell)",
        description: "Thrive for excellence.",
      },
      {
        source: "dod",
        type: "Chapter House of the Adeptus Astartes",
        placeholder: "[Chapter]",
        name: "Shadow Tales (House Hironiat)",
        description: "Break the Tide.",
      },

      // [Legion] -> Let the Galaxy Burn
      {
        source: "ltgb",
        type: "Legion of the Heretic Astartes",
        placeholder: "[Legion]",
        name: "Black Legion",
        description: "",
      },
      ...
      {
        source: "tnh",
        type: "Enclave of the Sisters of Silence",
        placeholder: "[Enclave]",
        name: "Raptor Guard",
        description: "",
      },
      ...
      // Eldar Craftworlds
      {
        type: "Aeldari Craftsworld",
        placeholder: "[Craftworld]",
        name: "Alaitoc",
        description:
          "The Starstriders: The Eldar of Alaitoc have spread further afi eld than other Craftworlds, acting as their people’s eyes and ears as they wander the galaxy. The warriors of Alaitoc favour stealth and misdirection over brute force.",
      },
      {
        type: "Aeldari Craftsworld",
        placeholder: "[Craftworld]",
        name: "Biel-Tan",
        description:
          "The Swordwind: This is the most militant of all Craftworlds. Those who strive hardest to return to the glory of their people before the Fall, the Eldar of Biel-Tan mourn the shattering of their Craftworld during an invasion by the forces of Slaanesh.",
      },
      {
        type: "Aeldari Craftsworld",
        placeholder: "[Craftworld]",
        name: "Iyanden",
        description:
          "The Ghost Warriors: Once a thriving Craftworld, Iyanden was invaded by Tyranids of Hive Fleet Kraken. The Eldar fought off this brutal assault at great cost. Now, most of the Craftworld is empty, forcing the Iyanden Farseers to call upon their fallen to fight for survival.",
      },
      {
        type: "Aeldari Craftsworld",
        placeholder: "[Craftworld]",
        name: "Saim-Hann",
        description:
          "The Wild Host: The Eldar of Saim-Hann are renowned for their fast, mobile warfare. They are a Craftworld of ancient tradition and a proud warrior culture. They observe many rituals that are unique to their Craftworld, including special races and duels.",
      },
      {
        type: "Aeldari Craftsworld",
        placeholder: "[Craftworld]",
      ...
      },
      {
        ...
        type: "Ork Clan",
        description:
          "Sabrous and scheming, the Deathskulls steal, loot, or scrounge whatever they can. Known to hoard, they ‘trade’ and customise gear more frequently than other Clans.",
      ...
      },
      {
        ...
        effect:
          "You gain +1 Speed, and +Rank bonus dice to all Tests whenever you are in a vehicle moving at top speed.",
        modification: {},
        modifications: [
      ...
      },
      {
        ...
        effect:
          "+Rank bonus dice to melee attack Tests when you Charge (p.189).",
        modification: {},
      },
      {
        name: "Snakebites",
      ...
      {
        type: "Navigator House",
        placeholder: "[Navis House]",
      ...
      {
        type: "Adeptus Arbited Predict",
        placeholder: "[Predict]",
        name: "Astra",
        description:
          "Precinct Astra is the designation for the diffused networks of a local sector, tasked with patrolling interstellar trade routes and monitoring crime within the void.",
      },
      {
        type: "Adeptus Arbited Predict",
        placeholder: "[Predict]",
        name: "Courthouse",
        description:
          "Sprawling hive cities typically also have their own Courthouse Precinct to aid in large scale monitoring, reporting to their central Precinct Fortress.",
      },
      {
        type: "Adeptus Arbited Predict",
        placeholder: "[Predict]",
        name: "Fortress",
        description:
          "Most Arbitrators operate out of massive Precinct Fortresses, located within capital cities in close proximity to the Planetary Governor of major Imperial worlds.",
      },
      {
        type: "Adeptus Arbited Predict",
        placeholder: "[Predict]",
        name: "House",
        description:
          "Remote planets of little importance typically have just a single fortified Precinct House for the single Arbitrator stationed there.",
      },
      {
        type: "Adeptus Arbited Predict",
        placeholder: "[Predict]",
        name: "Op-Center",
        description:
          "Operational centers are forward operating bases maintained throughout Imperial worlds, particularly hive or industrial worlds, with each being a garrison for a few dozen Arbitrators who report to their nearest precinct.",
      },
      ...
      // AAOA Squat Leagues
      {
        ...
        name: "League of Thor",
        description:
          "The most powerful and influential League, once containing more than three hundred Strongholds. What remains is a fleet of a thousand ships, sailing through the inky void of the Imperium Nihilus, seeking allies.",
      },
      {
        source: "aaoa",
        type: "Squat League",
        placeholder: "[League]",
        name: "League of Emberg",
        description:
          "The furthest League from the galactic core, lying near to the Eye of Terror. The remnants gathered up with survivors from Cadia and are currently waging a crusade of vengeance against any of the forces of Chaos they encounter.",
      },
      {
        source: "aaoa",
        type: "Squat League",
        placeholder: "[League]",
        name: "League of Kapellar",
        description:
          "The League with the greatest number of member Strongholds, though none so influential as those within the League of Thor. The remnants are scattered far and wide and can normally be found hiring themselves out as mercenaries as they search for signs of their kin.",
      },
      {
        source: "aaoa",
        type: "Squat League",
        placeholder: "[League]",
        name: "League of Norgyr",
        description:
          "The first of the Leagues to be discovered by the Great Crusades, due to its relative proximity with Earth. Most of the survivors rallied to the Imperium after the cataclysm, and now scour the western edge of the rift looking for other Squats and for Chaos raiders.",
      },
      {
        source: "aaoa",
        type: "Squat League",
        placeholder: "[League]",
        name: "League of Grindel",
        description:
          "A rival to the League of Thor, who waged war against them in the 39th Millennium until they united in the face of WAAAGH Grunhag. Few survived the cataclysm, and the survivors have tried to settle a world near the rift in the Imperium Nihilus.",
      },
      ...
      },
      {
        ...
        placeholder: "[Gang]",
        description:
          "Justice in the underhive is a rough and ready affair, administered chiefly by merchant guilds under the supervision of each settlement’s most powerful guilder. These rich and influential individuals keep the peace inside the towns and oversee any trading that goes on there.\n" +
