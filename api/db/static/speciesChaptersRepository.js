...
const core = [
  {
    ...chapterz(
      ...
      "Sanguinius",
      "Imperium",
      "First Founding (IX Legion)"
    ),
    hint: "Masters of Melee, compelled to drink the enemies blood.",
    beliefsAndTraditions: [
      {
        name: "Savage Echoes",
        effect: "You may reroll Double Rank dice on any melee attack Test.",
      },
      {
        name: "The Red Thirst",
        origin: "Gene-seed",
  ...
  },
  {
    ...chapterz(
      ...
      "Lion El`Jonson",
      "Imperium",
      "First Founding (I Legion)"
    ),
    beliefsAndTraditions: [
      {
        name: "Grim Resolve",
        effect:
          "You may reroll Double Rank dice when you Aim and make a ranged attack.",
      },
      {
        name: "The Unforgiven",
        origin: "Tradition",
        effect:
          "You suffer a +2 DN penalty to any social Tests made against anyone outside of your Chapter",
      },
    ],
  },
  {
    ...chapterz(
      ...
      "Regal Dorn",
      "Imperium",
      "First Founding (VII Legion)"
    ),
    beliefsAndTraditions: [
      {
        name: "Siege Masters",
        effect:
          "You may reroll Double Rank dice whenever you attack a building, fortification, or enemy in cover. You may also add +Rank dice whenever you make a Test related to architectural engineering",
      },
      {
        name: "Geen-seed Flawed",
        origin: "Geen-Seed",
        effect:
          "You are missing implant 12: Sus-an Membrane, and implant 17: Bletcher’s Gland. See below for more information on Space Marine implants.",
      },
    ],
  },
  {
  ...
  },
  {
    ...chapterz(
      ...
      "Corvus Corax",
      "Imperium",
      "First Founding (XIX Legion)"
    ),
    beliefsAndTraditions: [
      {
        name: "Master of Shadows",
        effect:
          "You may reroll Rank dice when you make a Stealth (A) Test. Running, using a Jump Pack, or similar circumstances do not affect your Stealth (A) Tests.",
      },
      {
        name: "Dark Heritage",
        origin: "Geen-seed",
        effect:
          "ou are missing implant 16: Mucranoid, and implant 17: Bletcher’s Gland. You suffer a + 1 DN penalty to any Fellowship based Test made against any target that could be frightened of your appearance. See below for more information on Space Marine implants",
      },
    ],
  },
  {
    ...chapterz(
      ...
      "Vulkan",
      "Imperium",
      "First Founding (XVIII Legion)"
    ),
    beliefsAndTraditions: [
      {
        name: "Promethian Cult",
        effect:
          "You may reroll Rank dice when you make an attack roll with a weapon with the FIRE or MELTA Keywords. You may reroll Double Rank dice when you roll Determination against a damage from a source with the FIRE or MELTA Keyword.",
      },
      {
        name: "Infernal Inheretance",
        origin: "Geen-seed",
        effect:
          "Whenever an ally within 30 metres of you is killed, the GM gains +1 Ruin. You suffer a + 2 DN penalty to any Fellowship-based Test made against any target that could be frightened of your appearance",
      },
    ],
  },
  {
    ...chapterz(
      ...
      "Lemon Russ",
      "Imperium",
      "First Founding (VI Legion)"
    ),
    beliefsAndTraditions: [
      {
        name: "Hunters Unleashed",
        effect:
          "You have the Acute Sense Talent (p.129) and the Dual Wield Talent (p.133).",
        modifications: [
          {
            targetGroup: "talents",
            targetValue: "core-acute-sense",
            meta: { name: "Acute Sense" },
          },
          {
            targetGroup: "talents",
            targetValue: "core-dual-wield",
            meta: { name: "Dual Wield" },
          },
        ],
      },
      {
  ...
  },
  {
    ...chapterz(
      ...
      "Jaghatai Khan",
      "Imperium",
      "First Founding (V Legion)"
    ),
    beliefsAndTraditions: [
      {
        name: "Lightning Assault",
        effect:
          "You may reroll Double Rank dice whenever you make a Pilot (A) Test. You triple your Speed when you Charge (p.189).",
      },
      {
        name: "Ritual Scarring",
        origin: "Tradition",
        effect:
          "You suffer a +1 DN penalty to any Fellowshipbased Test made against any target that could be frightened of your appearance.",
      },
    ],
  },
];
...
const aaoa = [
  {
    ...
    beliefsAndTraditions: [
      simpleEffect(
        "Righteous Zeal: When you charge, you may re-roll up to Rank dice on your Weapon Skill test. In addition, you may re-roll Rank dice when they roll Determination."
      ),
      simpleEffect(
        "Gene-Seed Flaw (Gene-Seed): You are missing the Sus-an Membrane (implant 12), and the Betcher’s Gland (implant 17)."
      ),
      simpleEffect(
        "Deny the Witch: Characters with the Black Templars keyword may not, under any circumstances, take the Psyker keyword: the Black Templars accept no psykers within their ranks."
      ),
    ],
  },
  {
    ...
    beliefsAndTraditions: [
      simpleEffect(
        "No Matter The Odds: When making an attack while you and your allies are outnumbered at least two-to-one, you may add Rank dice to your Ballistic Skill or Weapon Skill test."
      ),
      simpleEffect(
        "Gene-Seed Flaw (Gene-Seed): You are missing the Sus-an Membrane (implant 12), and the Betcher’s Gland (implant 17)."
      ),
  ...
  },
  {
    ...
    beliefsAndTraditions: [
      simpleEffect(
        "Daemonbane: When attacking a creature with the Daemon keyword in melee combat, you add +Rank ED to the attack’s damage. You also add +Rank to your Conviction."
      ),
      simpleEffect(
        "Secretive (Tradition): You suffer a +2DN penalty for Interaction tests involving anyone who lacks the Grey Knights or Inquisition keywords."
      ),
    ],
  },
  {
    ...chapterz(
      ...
      "Fulgrim",
      "Chaos",
      "First Founding (III Legion)"
    ),
    beliefsAndTraditions: [
      simpleEffect(
        "In Pursuit of Perfection: Select one of the following skills: Awareness, Ballistic Skill, Leadership, Pilot, Weapon Skill. You gain +Rank dice as a bonus to all uses of that skill."
      ),
      simpleEffect(
        "Fear of Imperfection (Tradition): Whenever you suffer a complication on the skill chosen for Pursuit of Perfection, above, the GM gains 1 Ruin, in addition to any other results.",
        "Tradition"
      ),
      simpleEffect(
        "Children of Slaneesh: Characters with the EMPEROR’S CHILDREN keyword must take SLAANESH as their [MARK OF CHAOS] keyword."
      ),
    ],
  },
  {
  ...
  },
  {
    ...chapterz(
      ...
      "Konrad Curze",
      "Chaos",
      "First Founding (VIII Legion)"
    ),
    beliefsAndTraditions: [
      simpleEffect(
        "Ave Dominus Nox: While under cover of darkness, you may add +Rank to your Defence and Speed.\n" +
      ...
      simpleEffect(
        "Blood of Nostramo (Tradition): If you see an ally fail a Resolve or Fear test, you must attempt a Resolve test (DN 3) or become pinned.",
        "Tradition"
      ),
    ],
  },
  {
    ...chapterz(
      ...
      "Angron",
      "Chaos, Khorne",
      "First Founding (XII Legion)"
    ),
    beliefsAndTraditions: [
      simpleEffect(
        "Incarnate Violence: You may reroll Double Rank dice on any melee attack test."
      ),
      simpleEffect(
        "Butcher’s Nails (Gene-Seed): Upon engaging in melee combat, you become Frenzied for the rest of the battle. The Willpower test to restrain your frenzy increases by +1 for every enemy you have killed during the battle.",
        "Gene-Seed"
      ),
      simpleEffect(
        "Children of Khorne: Characters with the WORLD EATERS keyword must take KHORNE as their [MARK OF CHAOS] keyword."
      ),
    ],
  },
  {
    ...chapterz(
      ...
      "Moartarion",
      "Chaos, Nurgle",
      "First Founding (XIV Legion)"
    ),
    beliefsAndTraditions: [
      simpleEffect(
        "Inexorable Advance: The short range of your ranged weapons is increased by Double Rank, up to a maximum of the weapon’s medium range. You suffer no penalty for operating a Heavy weapon without bracing it, nor do you suffer the +2 DN for firing an Assault weapon when Running."
      ),
      simpleEffect(
        "Intractable (Tradition): You must spend a point of Glory to take the Sprint action.",
        "Tradition"
      ),
      simpleEffect(
        "Children of Nurgle: Characters with the DEATH GUARD keyword must take NURGLE as their [MARK OF CHAOS] keyword."
      ),
    ],
  },
  {
    ...
    beliefsAndTraditions: [
      {
        ...
        modifications: [
          {
            targetGroup: "talents",
            targetValue: "core-favoured-by-the-warp-talent",
            meta: { name: "Favoured By The Warp talent" },
          },
        ],
      },
      simpleEffect(
        "Gift of Mutation (Gene-Seed): You gain an additional +1 Corruption whenever you would gain one or more Corruption points. You also increase the DN of all tests to resist Corruption or Malignancy by +1.",
        "Geen-Seed"
      ),
      simpleEffect(
        "Children of Tzeench: Characters with the THOUSAND SONS keyword must take TZEENTCH as their [MARK OF CHAOS] keyword."
      ),
    ],
  },
  {
    ...chapterz(
      ...
      "Horus Lupercal",
      "Chaos",
      "First Founding (XVI Legion)"
    ),
    beliefsAndTraditions: [
      simpleEffect(
        "The Tip of the Spear: You add +Rank bonus dice on all Ballistic Skill tests made with a ranged weapon at close range. " +
          "You also gain +1 Resolve."
      ),
      simpleEffect(
        "Bitter Pride (Tradition): You suffer a +2DN penalty for Interaction tests involving anyone outside the Black Legion, unless those people are subordinate to the Black Legion character."
      ),
    ],
  },
  {
    ...chapterz(
      ...
      "Logar Aurelian",
      "Chaos",
      "First Founding (XVII Legion)"
    ),
    beliefsAndTraditions: [
      simpleEffect(
        "Profane Zeal: You may reroll any failed Resolve test. In addition, you are immune to fear caused by creatures with the DAEMON keyword."
      ),
      simpleEffect(
        "The Will of the Gods (Tradition): You start each session with 1 Wrath Point instead of 2.",
        "Tradition"
      ),
    ],
  },
  {
    ...chapterz(
      ...
      "Alpharius Omegon",
      "Chaos",
      "First Founding (XX Legion)"
    ),
    beliefsAndTraditions: [
      simpleEffect(
        "Mutable Tactics: After each Respite, select one of the following skills: Athletics, Cunning, Deception, Intimidation, Persuasion, Stealth, or Tech. You may re-roll up to Rank dice on any test involving the chosen skill."
      ),
      simpleEffect(
        "I Am Alpharius (Tradition): Add 1 to Ruin when you fail an Intelligence test, as your carefully-wrought plans and contingencies fail you.",
        "Tradition"
      ),
    ],
  },
...
const dod = [
  {
    ...
    beliefsAndTraditions: [
      ...
      },
      {
        ...
        origin: "Tradition",
        effect:
          "A Isenweller who breaks his word is without honor, and to purposefully use a false oath to deceive an enemy is the lowest cowardice. If the Isenweller says that he will perform an action, and then does not at least earnestly attempt to perform that action, then the GM gains 2 ruin. ",
      },
    ],
  },
  {
