...
const statMax = function (str, tou, agi, ini, wil, int, fel, spe) {
  return {
    ...
    traitMaximums: [{ name: "Speed", value: spe }],
  };
};

const statBoost = function (str, dex, con, wis, int, cha) {
  return {
    attributeBoost: [
      { name: "Сила", value: str },
      { name: "Ловкость", value: dex },
      { name: "Телосложение", value: con },
      { name: "Мудрость", value: wis },
      { name: "Интеллект", value: int },
      { name: "Харизма", value: cha },
    ],
  };
};
...
const rotss = [
  // Грим
  {
    ...species("rotss", 1, "Grim", "Grim", "Создания воды", 0, 30),
    ...statBoost(0),
    nameSpecies: "Грим",
    options: [
      {
        name: "Харизма",
        snippet: "Вы получаете +1 к Харзиме",
        modifications: [
          {
            targetGroup: "attribute",
            targetValue: "charisma",
            modifications: [addModifier("attributes", ATTRIBUTES.CHARISMA, 1)],
          },
        ],
      },
      {
        name: "Интеллект",
        snippet: "Вы получаете +1 к Интеллекту",
        modifications: [
          {
            targetGroup: "attribute",
            targetValue: "intellect",
    ...
    desc: [
      {
        name: "Существа Воды",
        description:
          "Все гримы жаждут воды – моря, реки или бассейна. Им приятно погружаться в воду и смотреть на мир вокруг себя, наблюдая и наблюдая на расстоянии. Гримы дышат под водой посредством первобытной магии, которую по-настоящему не понимает ни один смертный. У них широкие и заостренные уши, а кожа, как правило, зеленая или синяя, что позволяет им гармонировать с темной средой обитания. Их глаза часто светло-желтые или зеленые, а кожные лоскуты на руках и ногах могут расши��яться, помогая им плавать.",
      },
    ],
...
const coreRep = [
    ...
    speciesFeatures: [
      {
        ...
        modifications: [
          { targetGroup: "abilities", targetValue: "all", modifier: 1 },
          // { targetGroup: "skill", targetValue: "survival", modifier: 1 },
        ],
      },
      {
        ...
        modifications: [
          { targetGroup: "languages", targetLanguages: [], freeLanguages: 1 },
          // { targetGroup: "skill", targetValue: "survival", modifier: 1 },
        ],
      },
      {
  ...
  // {
  //   ...species("core", 29, "Human", "Human", "The humble human", 0, 6),
  //   ...cost(0, 0, 0, 0),
  //   ...commonNames(
  ...
  //       snippet:
  //         "You are subject to the orders of your chapter master, and must honour both the beliefs and traditions of your chapter. You increase your Resolve by 1.",
  //       modifications: [
  ...
  //       snippet:
  //         "You are subject to the orders of your chapter master, and must honour both the beliefs and traditions of your chapter. You ignore impurities in the Gene-Seed. You increase Resolve by 1 and Max Wounds by 3.",
  //       modifications: [
  //         { targetGroup: "traits", targetValue: "resolve", modifier: 1 },
  ...
  //       name: "Space Marine Implants",
  //       snippet:
  //         "You are immune to the Bleeding Condition. You gain +1 bonus dice to any test related to one of the 21 implants (p.76) if the GM agrees it is appropriate.",
  //     },
  //   ],
  // },
  // {
  ...
  //         {
  //           type: "warning",
  //           text: "For the PSYKER variant choose the Aeldari (Psychosensitive) species variant.",
  //         },
  //       ],
  //     },
  //     {
  ...
  //           snippet: "You gain +Rank bonus dice to Awareness (Int) Tests.",
  //           modifications: [
  //             {
  //               targetGroup: "skills",
  //               targetValue: "awareness",
  //               modifier: 0,
  //               rank: 1,
  //             },
  //           ],
  ...
  //           snippet:
  //             "You gain +Double Rank bonus dice to Scholar (Int) Tests related to the AELDARI Keyword.",
  //           modifications: [
  //             {
  //               targetGroup: "skills",
  //               targetValue: "scholar",
  ...
  //           snippet:
  //             "You gain +Double Rank bonus dice to Tech (Int) Tests on targets with the AELDARI Keyword.",
  //           modifications: [
  //             {
  //               targetGroup: "skills",
  //               targetValue: "tech",
  //               modifier: 0,
  //               rank: 2,
  //               condition: "targets with the AELDARI Keyword",
  //             },
  //           ],
  //         },
  //         {
  ...
  //             {
  //               targetGroup: "traits",
  //               targetValue: "conviction",
  //               modifier: 0,
  //               rank: 1,
  //               condition: "to corruption tests",
  //             },
  //           ],
  //         },
  //         {
  ...
  //           snippet:
  //             "You gain +Double Rank bonus dice to Medicae (Int) Tests on targets with the AELDARI Keyword.",
  //           modifications: [
  //             {
  //               targetGroup: "skills",
  //               targetValue: "medicae",
  ...
  //               modifier: 0,
  //               rank: 2,
  //               condition: "when using AELDARI vehicles",
  //             },
  //           ],
  //         },
  //       ],
  ...
  //       description:
  //         "<p>You have the <strong>PSYKER</strong> Keyword. You gain access to the <em>Minor</em>, <em>Universal</em>, <em>Divination</em> and <em>Runes of Battle</em> Disciplines. You also gain access to on additional Discipline.</p>",
  //       modifications: [{ targetGroup: "keywords", targetValue: "Psyker" }],
  //       selected: [""],
  //       options: [
  ...
  //   ...cost(20, 20, 0, 0),
  //   ...commonNames(
  //     "Arrlug, Balgrog, Blacktoof, Bluddflak, Bonesmasha, Dedak, Dragnatz, Eddbasha, Garahak, Gargash, Garmek, Genghiz, Gorbad, Grimskull, Hackitt, Hruk, Klawjaw, Kozdek, Lug, Morglum, Murgor, Nazhakka, Rakka, Rekkfist, Rotchop, Skarjaw, Skubmak, Urkthrall, Vorhgad, Zogax"
  //   ),
  ...
  //       snippet:
  //         "You calculate Influence using Strength instead of Fellowship.",
  //     },
  //   ],
  // },
];
