...
/*Шаблон для класса
... ...archetype(source.core.key
  , 92, "Warrior", "Warrior", 1, "Human"),
   hint: "Подсказка под заголовком",
   nameClass: "Название класса для отображения",
   hitDice: "d10" // после d любая цифра,
   hitLevelOne: 10 // цифра без мод Тела,
       classFeature: [ // классовые особенности (без архетипа)
      {
        name: "Боевой стиль", //Имя
        snippet: //описания особенности
        ...
        options: "FSWarrior", //если есть какой-то выбор внутри. Сами опции добавляются в KeywordRepositoryMixin
        level: 1, //уровень получения
        use: 1, //опционально, если есть использования
      },*/
...
const core = [
  // Adeptus Ministorum
  {
    //После цифры это фракция
    ...archetype(source.core.key, 92, "Warrior", "Warrior", 1, "Human"),
    //...archetype(source.core.key, 92, "Воин", "Adeptus Ministorum", 1, "Human"),
    ...cost(12, 0, 12, 0, 0),
    hint: "Бьёт оружием не хуже других",
    nameClass: "Воин",
    keywords: "Класс, Корник, FSWarrior",
    prerequisites: [
...
//   {
//     //После цифры это фракция
//     ...archetype(source.core.key, 92, "Воин", "Warrior", 1, "Human"),
//     //...archetype(source.core.key, 92, "Воин", "Adeptus Ministorum", 1, "Human"),
//     ...cost(12, 0, 12, 0, 0),
//     hint: "ывфвфвфывфывфыв.",
//     name: "Воин",
...
//         name: "Glancing Blow",
//         snippet:
//           "Unless you are immobilised or restrained, you may roll Determination against Damage from attacks and against Mortal Wounds. You may use Agility instead Toughness for Determination when doing so.",
//         description:
//           "<p>You depend upon your swift movement and honed reflexes to avoid harm. You may use your Agility instead of your Toughness when you roll Determination against Damage from attacks, and may roll Determination against Mortal Wounds. You cannot use this ability if you are immobilised in some way, such as through the Restrained Condition.</p>",
//       },
//     ],
//     wargear: wargearz(
//       "2 Death Cult Powerblade/Two Death Cult Powerblades, Bodyglove, Knife, Laspistol, 3 dose of Stimm"
//     ),
//     influence: 1,
//   },
//   {
...
//         snippet:
//           "You gain +Double Rank bonus dice to melee attack tests against targets with the CHAOS or HERETIC keyword. Your Resolve also increases by +Rank.",
//         modifications: [
//           {
//             targetGroup: "traits",
//             targetValue: TRAITS.RESOLVE,
//             modifier: 0,
//             rank: 1,
//           },
//         ],
...
//     ],
//     wargear: wargearz(
//       "Power Sword, Storm Shield, Carapace Armour, Clothing/Ministorum Robes"
//     ),
//     influence: 1,
//   },
//   // Adepta Sororitas
...
//         snippet:
//           "Add +Double Rank bonus dice for Medicae (Int) Test on an IMPERIUM character.",
//         description:
//           "<p>+Double Rank bonus dice whenever you make a Medicae (Int) Test on a character with the <strong>IMPERIUM</strong> Keyword</p>",
//       },
//     ],
//     wargear: [
...
//         variant: "Copy of the Rule Of The Sororitas",
//       },
//     ],
//   },
//   {
...
//         snippet:
//           "You and any allies within 15 metres gain +Double Rank bonus dice to Corruption Tests. You gain +Double Rank bonus dice to any Test to resist the effects of a Psychic Power.",
//       },
//     ],
//     wargear: [
//       { name: "Sororitas Power Armour" },
...
//         selected: "Boltgun",
//         options: [{ name: "Boltgun" }, { name: "Chainsword and Bolt Pistol" }],
//       },
//       { name: "Clothing", variant: "Sororitas vestments" },
//       { name: "Writing Kit" },
//       {
...
//     prerequisites: [reqSkill(SKILLS.BALLISTIC_SKILL, 2)],
//     archetypeFeatures: [
//       {
//         name: "Look Out, Sir!",
//         snippet:
//           "Once per combat, as a Reflexive Action, move up to half your Speed to intercept an attack that hit an ally. You Resilience is increased by +Rank.",
//         description:
//           "<p>You have been drilled in sacrificing yourself to save your allies. Once per combat, you may take a Reflexive Action to move up to half your Speed to get in the way of any attack that hit an ally. The attacker then rolls against your Resilience instead of your ally’s, and may deal Wounds to you. Your Resilience increases by +Rank for the purpose of calculating damage.</p>",
//         // TODO conditional modifier
//       },
//     ],
//     wargear: wargearz(
//       "Flak Armour, Lasgun, Knife, Munitorum-Issue Mess Kit, Grooming kit, Uplifting Primer/A copy of the Imperial Infantryman’s Uplifting Primer, 3 ration packs"
//     ),
//     suggestedStats: [
...
//         name: "Elite Soldier",
//         snippet:
//           "You’re an expert in inflicting pain through the weapons of the Imperium. Whenever you spend Glory to increase damage when using a weapon with the ASTRA MILITARUM you can add +Rank to the final damage value.",
//       },
//     ],
//     wargear: wargearz(
//       "Tempestus Carapace, Hot-Shot Lasgun, Grav-Chute, Knife, Munitorum-Issue Mess Kit, Uplifting Primer/a copy of the Imperial Infantryman’s Uplifting Primer, Slate Monitron, Monoscope, 3 ration packs"
//     ),
//     influence: 1,
//   },
//   {
...
//         snippet:
//           "You and any allies within 15 metres of you that can see you may add +Double Rank bonus dice to Resolve Tests. You add +Double Rank bonus dice to any Intimidation (Wil) Tests, including Interaction Attacks.",
//         modifications: [
//           {
//             targetGroup: "traits",
//             targetValue: TRAITS.RESOLVE,
//             modifier: 0,
//             rank: 2,
//             condition: "for You and allies within 15 metres",
//           },
//           {
//             targetGroup: "skills",
...
//     ],
//     wargear: wargearz(
//       "Bolt Pistol, Chainsword, Flak Coat, Munitorum-Issue Mess Kit, Blanket, Grooming Kit, Uplifting Primer, 3 ration packs"
//     ),
//     influence: 3,
//   },
//   // Inquisition
...
//         snippet:
//           "You can invoke the name of your Inquisitor to gain +Rank bonus dice to any social Skill test when interacting with an individual with the IMPERIUM. You can only use this ability once per scene.",
//       },
//     ],
//     wargearString:
...
//           {
//             targetGroup: "skills",
//             targetValue: SKILLS.INVESTIGATION,
//             modifier: 0,
//             rank: 1,
//             condition: "when gathering information from Imperial sources",
//           },
//         ],
//       },
//     ],
//     wargear: wargearz(
//       "Clothing/Administratum Robes, Laspistol, Knife, Auto-Quill, Data-Slate, 3 Scroll of Ancient Records"
//     ),
//     influence: 1,
//   },
//   {
...
//         snippet:
//           "You are a master of manipulating a situation to your advantage. You gain +Rank bonus dice to all Persuasion (Fel) Tests and Influence tests to acquire goods and services.",
//         modifications: [
//           {
//             targetGroup: "skills",
...
//             modifier: 0,
//             rank: 1,
//             condition: "when acquiring goods and services.",
//           },
//           {
//             targetGroup: "traits",
...
//     ],
//     wargearString:
//       "Imperial Frigate. Choose any two pieces of Wargear with a Value of your Tier +4 or less, and a Rarity of Rare or lower. Choose from any of the following options; Flak Coat or Carapace Armour or Light Power Armour.",
//     wargear: [
...
//         name: "Psyker",
//         snippet:
//           "You know 1 Minor Psychic Power and the Smite psychic power. You may purchase additional psychic powers, following the rules in Chapter 11.",
//         description:
...
//         snippet:
//           "You gain access to the Minor and Universal Disciplines. You unlock an addtional single Psychic Discipline.",
//         description:
//           "<p>You gain access to the Minor and Universal Disciplines. You unlock an additional single Psychic Discipline, following the rules in Chapter 11.</p>",
//         selected: [""],
//         options: [
...
//             name: "Biomancy",
//             modifications: [
//               { targetGroup: "psychicDisciplines", targetValue: "Biomancy" },
//             ],
//           },
//           {
//             key: "core-divination",
...
//             name: "Pyromancy",
//             modifications: [
//               { targetGroup: "psychicDisciplines", targetValue: "Pyromancy" },
//             ],
//           },
//           {
...
//             name: "Telekinesis",
//             modifications: [
//               { targetGroup: "psychicDisciplines", targetValue: "Telekinesis" },
//             ],
//           },
//           {
//             key: "core-telepathy",
//             name: "Telepathy",
//             modifications: [
//               { targetGroup: "psychicDisciplines", targetValue: "Telepathy" },
//             ],
//           },
//           {
...
//             name: "Maleficarum",
//             modifications: [
//               { targetGroup: "psychicDisciplines", targetValue: "Maleficarum" },
//             ],
//           },
//           {
...
//           },
//         ],
//         psychicDisciplines: ["Minor", "Universal"],
//       },
//     ],
//     wargear: wargearz(
//       "Laspistol, Force Stave, Psykana Mercy Blade, Munitorum-Issue Mess Kit, Blanket, Grooming kit, 2 ration packs"
//     ),
//   },
//   {
//     ...archetype(
...
//         snippet:
//           "You have supreme authority to maintain the security of the Imperium. You gain +Double Rank bonus dice whenever you make a social Skill Test against a character with the IMPERIUM keyword.",
//       },
//     ],
//     wargearString:
//       "Inquisitorial Rosette, Any two weapons with a Value of 7 or less and a Rarity of Very Rare or lower, Choose one of the following options: Flack Coat or Carapace Armour or Ignatus Power Armour or Light Power Armour",
//     wargear: [
...
//         snippet:
//           "You gain +Rank to any Stealth (A) Test when there is some form of terrain to hide behind.",
//         modifications: [
//           {
//             targetGroup: "skills",
//             targetValue: SKILLS.STEALTH,
//             modifier: 0,
//             rank: 1,
//             condition: "when there is some form of terrain to hide behind",
//           },
//         ],
//       },
//     ],
...
//       {
//         type: "info",
//         text: "The errata states the cost as 277 but this is probably an error. Thus, we use 272 XP as the cost.",
//       },
//     ],
//     archetypeFeatures: [
//       {
...
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Boltgun, Bolt Pistol, Astartes Combat Knife, 3 Frag Grenade, 3 Krak Grenade"
//     ),
//     influence: 2,
//   },
//   {
...
//         snippet:
//           "You gain +Double Rank bonus dice to any Ballistic Skill Tests to fire a ranged weapon with the PRIMARIS Keyword.",
//         modifications: [
//           {
//             targetGroup: "skills",
//             targetValue: SKILLS.BALLISTIC_SKILL,
//             modifier: 0,
//             rank: 2,
//             condition: "when firing a PRIMARIS weapon.",
//           },
//         ],
//       },
//     ],
//     wargear: wargearz(
//       "Tacticus Mk X/Mark X Tacticus Power Armour, Bolt Rifle, Heavy Bolt Pistol, Astartes Combat Knife, 3 Frag Grenade, 3 Krak Grenade"
//     ),
//     influence: 1,
//   },
//   // Adeptus Mechanicus
...
//         snippet:
//           "Your body has been redesigned to withstand the rigours of war. You do not bleed (making you immune to the Bleeding) and gain +Rank bonus dice to Determination rolls.",
//       },
//     ],
...
//         name: "Rite of Repair",
//         snippet:
//           "You receive +Double Rank to Tech (Int) Tests to repair damaged machinery. All Tech (Int) Tests you make take half the standard time.",
//         modifications: [
//           {
//             targetGroup: "skills",
//             targetValue: SKILLS.TECH,
//             modifier: 0,
//             rank: 2,
//             condition: "when repairing damaged machinery",
//           },
//         ],
//       },
//     ],
//     wargearString:
//       "Omnissian Axe, Laspistol, One Mechadendrite, any 2 Augmetics, Combi-Tool, Light Power Armour, Omnissian Sigil (Symbol of Authority)",
//     wargear: [
//       { name: "Omnissian Axe" },
//       { name: "Laspistol" },
//       {
...
//     keywords: "Scum,[Any]",
//     prerequisites: [reqSkill(SKILLS.CUNNING, 1)],
//     archetypeFeatures: [
//       {
//         name: "Scrounger",
//         snippet:
//           "You add +Rank dice to Cunning Tests. Once per session you may make an Influence or Cunning Test to acquire an item, representing something you have prepared in advance.",
//         description:
...
//     ],
//     wargearString:
//       "A Knife or a Sword, Bedroll, Canteen, Gang colours, any one of the following: a Laspistol or an Autopistol or a Hand Cannon or a Stubber",
//     wargear: [
//       {
...
//         name: "Mutant",
//         snippet:
//           "You start with two mutations (pg. 287). Whenever your Rank increases, you may select another Mutation.",
//         description:
//           "<p>Your life in the unsanitary underbelly of the Imperium has mutated you. Select two Mutations from the list of Scavvy Mutations on p.287. Whenever your Rank increases, you may select another Mutation from the list.</p>",
//         alerts: [
//           {
//             type: "warning",
//             text: "In case the mutation modifiers are not displayed correctly in the WEB or PRINT view, please clear and re-select your mutations.",
//           },
//           {
//             type: "info",
...
//             snippet:
//               "Add 1 dice to Awareness (Int) Tests. You suffer +1 DN to actions that require vision, while exposed to light.",
//             modifications: [
//               {
//                 targetGroup: "skills",
...
//             snippet:
//               "Add +Rank dice to social tests. Psykers within 25m must reroll Wrath Dice without compolications.",
//           },
//           {
//             name: "Living Shadow",
//             snippet:
//               "You are aware of any Ambush as if you had spend a Point of Glory. You suffer +1 DN to opposing psychic powers of its effect.",
//           },
//           {
//             name: "Gossamer Flesh",
//             snippet:
//               "You gain +Double Rank dice to Awareness (Int) Tests involving touch. You Reduce Resistance and Max Shock by 1. You suffer +1 DN to resist painfull contact.",
//             modifications: [
//               {
//                 targetGroup: "skills",
//                 targetValue: SKILLS.AWARENESS,
//                 modifier: 0,
//                 rank: 2,
//                 condition: "when involving touch",
//               },
//               {
//                 targetGroup: "traits",
//                 targetValue: TRAITS.RESILIENCE,
//                 modifier: -1,
//               },
//               {
//                 targetGroup: "traits",
//                 targetValue: TRAITS.MAX_SHOCK,
//                 modifier: -1,
//               },
//             ],
//           },
...
//             name: "Blightend Soul",
//             snippet:
//               "You add +1 dice to resist Poison. You and anyone within 10m suffer +1 DN to Corruption and Malignancy Tests.",
//           },
//           {
//             name: "Wyrdling",
//             snippet:
//               "You gain the PSYKER Keyword. You gain one Minor Psychic Power (GM choice). If you already are a PSYKER, you gan one aditional Minow Psychic Power.",
//           },
//           {
//             name: "Misshapen",
...
//             name: "Grotesque",
//             snippet:
//               "You add +1 die to Intimidation (Wil) Tests. You suffer +1 DN to (other) social interaction tests with non-CHAOS.",
//             modifications: [
//               {
//                 targetGroup: "skills",
//                 targetValue: SKILLS.INTIMIDATION,
...
//             name: "Bestial Hide",
//             snippet:
//               "Increase your Resilience by 1. You add +1 dice to Intimidation (Wil) Tests. You suffer +2 DN to (other) social interaction tests with non-CHAOS.",
//             modifications: [
//               {
//                 targetGroup: "traits",
//                 targetValue: TRAITS.RESILIENCE,
...
//             name: "Brute",
//             snippet:
//               "Increase your Strength and Toughness by 1. You suffer +1 DN to all tests involving Tools and Range Weapons, if they are not adjusted to your build.",
//             modifications: [
//               {
...
//               {
//                 targetGroup: "attributes",
//                 targetValue: ATTRIBUTES.TOUGHNESS,
//                 modifier: 1,
//               },
//             ],
//           },
...
//             name: "Toxic Blood",
//             snippet:
//               "You are immune to Poisend and diseases. Any Medicae Test on you suffers +2 DN. On a Complication, the Medic must pass DN 4 Toughness or suffer one Mortal Wound.",
//           },
//           {
//             name: "Withered",
//             snippet:
//               "Increase your Willpower by 2. Reduce your Toughness by 1.",
//             modifications: [
//               {
//                 targetGroup: "attributes",
//                 targetValue: ATTRIBUTES.WILLPOWER,
//                 modifier: 2,
//               },
//               {
//                 targetGroup: "attributes",
...
//             name: "Vile Alacrity",
//             snippet:
//               "Increase your Speed by 2. Add +1 dice to Athletic (Str) tests. You suffer (at least) +2 DN to social interaction tests with non-CHAOS.",
//             modifications: [
//               { targetGroup: "traits", targetValue: TRAITS.SPEED, modifier: 2 },
//               {
//                 targetGroup: "skills",
//                 targetValue: SKILLS.ATHLETICS,
//                 modifier: 1,
//               },
//             ],
//           },
...
//         selected: "Laspistol",
//         options: [{ name: "Laspistol" }, { name: "Autpistol" }],
//       },
//       { name: "Knife" },
//       { name: "Bedroll" },
//       { name: "Canteen" },
...
//         name: "Valuable Prey",
//         snippet:
//           "You gain +Rank bonus dice on Cunning Tests, and any Test made to track an individual.",
//       },
//     ],
//     wargearString:
//       "Flak Coat, Preysense Goggles, Maps of the Heartworlds, Combi-Tool, any PROJECTILE weapon, any melee weapon of Uncommon or lower Rarity.",
//     wargear: [
//       { name: "Flak Coat" },
...
//         name: "Enemy Within",
//         snippet:
//           "You gain +Double Rank bonus dice to Deception (Fel) Tests, including Interaction Attacks, against targets with the IMPERIUM Keyword.",
//         modifications: [
//           {
//             targetGroup: "skills",
...
//             modifier: 0,
//             rank: 2,
//             condition: "against IMPERIAL targets",
//           },
//         ],
//       },
//       {
...
//           {
//             key: "corruption-1",
//             name: "Gain 1 point Corruption",
//             modifications: [
//               {
//                 targetGroup: "traits",
//                 targetValue: TRAITS.CORRUPTION,
//                 modifier: 1,
//               },
//             ],
//           },
...
//         name: "Unlock Disciplines",
//         snippet:
//           "You gain access to the Minor and Universal disciplines. You may unlock the Maleficarum discipline. You unlock an additional single Psychic Discipline.",
//         description:
//           "<p>You gain access to the Minor and Universal disciplines. You unlock an additional single Psychic Discipline, following the rules in Chapter 11.</p>",
//         selected: [""],
//         options: [
...
//     keywords:
//       "Imperium,Adeptus Mechanicus,Cult Mechanicus,[Forge World],Chaos,Dark Mechanicus",
//     archetypeFeatures: [
//       {
//         name: "Rite of Repair",
//         snippet:
...
//     keywords:
//       "Imperium,Adeptus Astartes,[Legion],Chaos,[Mark of Chaos],Heretic Astartes",
//     alerts: [
//       {
//         type: "info",
//         text: "The errata states the cost as 277 but this is probably an error. Thus, we use 272 XP as the cost.",
...
//         snippet:
//           "You throw yourself into danger with reckless abandon to hide your ancestral fears. You gain +Rank bonus dice whenever you make or resist an Athletics (S) or Persuasion (Fel) Attack. You suffer a +1 DN penalty to Fear Tests.",
//       },
//     ],
//     wargear: wargearz(
//       "Corsair Armour, Shuriken Pistol, Lasblaster, Spirit Stone, 3 Plasma Grenade, Void Suit"
//     ),
//   },
//   {
...
//         snippet:
//           "You are adept at exploiting any form of concealment. Whenever a Vision Penalty (p.191) or Cover (p.181) impose a penalty on someone trying to attack or detect you, the penalty is increased by +Rank DN.",
//         modifications: [
//           {
//             targetGroup: "traits",
//             targetValue: "defence",
//             modifier: 0,
//             rank: 1,
//             condition: "when obscured (vision penalty) or in cover",
//           },
//         ],
//       },
//     ],
//     wargear: wargearz(
//       "Cameleoline Cloak, Aeldari Mesh Armour, Ranger Long Rifle, Shuriken Pistol, Knife, Spirit Stone, Bedroll, Blanket, Magnocular Scope"
//     ),
//   },
//   {
...
//         name: "Runes of Battle",
//         snippet:
//           "You are a Psyker; you know the Smite psyhcic power, a single Runes of Battle psychic power and may learn other powers as described in Chapter 11.",
//         psychicPowers: [
//           {
//             name: "psykerSmite",
//             selected: "Smite",
...
//           },
//           {
//             name: "psykerRunesOfBattle",
//             selected: "Runes of Battle",
//             query: { discipline: "Runes of Battle" },
//             options: [],
//             free: true,
//           },
//         ],
...
//         name: "Unlock Disciplines",
//         snippet:
//           "You gain access to the Minor, Universal, Divination and Runes of Battle Disciplines. You also gain access to on additional Discipline.",
//         description:
...
//           {
//             key: "aaoa-runes-of-shaping",
//             name: "Runes of Shaping",
//             modifications: [
//               {
//                 targetGroup: "psychicDisciplines",
//                 targetValue: "Runes of Shaping",
//               },
//             ],
//           },
//         ],
...
//         name: "Kunnin' Plan",
//         snippet:
//           "You and any of your allies with the ORK within 15 metres gain +Rank bonus dice to Stealth (A) Tests.",
//         modifications: [
//           {
//             targetGroup: "skills",
//             targetValue: SKILLS.STEALTH,
//             modifier: 0,
//             rank: 1,
//             condition: "for You and ORK allies within 15 metres",
//           },
//         ],
//       },
//     ],
...
//         name: "The Green Tide",
//         snippet:
//           "You command a mob of Boyz (p.354) equal to your Rank x3. If any of your Boyz die, they can be replaced between sessions at the GMs discretion.",
//       },
//     ],
...
//         options: [{ name: "Brazier of Holy Fire" }, { name: "Null Rod" }],
//       },
//     ],
//     influence: 3,
//   },
...
//         name: "Prime helix",
//         snippet:
//           "When you succeed on a Medicae Test to heal a target’s Wounds, they recover +Rank additional Wounds.",
//       },
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Bolt Pistol, Chainsword, 3 Frag Grenade, 3 Krak Grenade, Narthecium, Reductor"
//     ),
//     influence: 2,
//   },
//   {
...
//         name: "Chapter Cult",
//         snippet:
//           "You gain 1 Faith, and can purchase Faith Talents available to characters with the ADEPTUS MINISTORUM Keyword.",
//       },
//       {
//         name: "Grant Brotherhood",
//         snippet:
//           "As a Combat Action, you may spend 1 Faith to give an ally within hearing distance your [CHAPTER] Keyword for the rest of the scene, with all corresponding effects except those with the Tradition or Gene-seed title, or that provide equipment.",
//       },
//       {
//         name: "Beacon of Tradition",
//         snippet:
//           "Any allies within 5xRank metres who share your [CHAPTER] Keyword gain +Rank to Resolve Tests.",
//       },
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Skull Helm, Crozius Arcanum, Bolt Pistol, Rosarius, 3 Frag Grenade, 3 Krak Grenade"
//     ),
//     influence: 2,
//   },
//   {
...
//           },
//           {
//             name: "psykerLibrarius",
//             selected: "",
//             query: { discipline: "Librarius" },
//             options: [],
//             free: true,
//           },
//         ],
...
//         name: "Unlock Disciplines",
//         snippet:
//           "You gain access to the Minor Universal and Librarius Disciplines. You unlock an additional single Psychic Discipline: Divination, Pyromancy, Telekinesis, Telepathy, Maleficarum",
//         description:
//           "<p>You gain access to the Minor Universal and Librarius Disciplines. You unlock an additional single Psychic Discipline: Divination, Pyromancy, Telekinesis, Telepathy, Maleficarum.</p>",
//         selected: [""],
//         options: [
//           // { key: 'core-minor', name: 'Minor', modifications: [{ targetGroup: 'psychicDisciplines', targetValue: 'Minor' }] },
//           // { key: 'core-universal', name: 'Universal', modifications: [{ targetGroup: 'psychicDisciplines', targetValue: 'Universal' }] },
...
//           },
//         ],
//         psychicDisciplines: ["Minor", "Universal", "Librarius"],
//       },
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Psychic Hood, Bolt Pistol, Force Stave, 3 Frag Grenade, 3 Krak Grenade"
//     ),
//     influence: 2,
//   },
//   // Primaris
...
//         name: "Terror Tactics",
//         snippet:
//           "When your Stealth Score is reduced to 0 or you Ambush a Threat, you can choose for all enemies who can see or hear you to take a Terror Test, with a DN equal to 1+Rank.",
//       },
//     ],
//     wargear: wargearz(
//       "Mk X Phobos Power Armour, Bolt Carbine, Heavy Bolt Pistol, Astartes Combat Knife, 3 Frag Grenade, 3 Krak Grenade, 3 Shock Grenade"
//     ),
//     influence: 1,
//   },
//   // Mechanicus
...
//         name: "Admin Access",
//         snippet:
//           "Your purpose is to commune with Machine Spirits and catalogue their wisdom, to further the Quest for Knowledge. When you commune with a Machine Spirit as part of a Test, you gain Icons equal to your Rank.",
//       },
//     ],
//     wargear: [
//       { name: "Laspistol" },
...
//         snippet:
//           "As a Combat Action, you may choose a number up to your Rank, and inflict that many Hindered Conditions on all characters within 10m that don’t have this ability or null-code audio inputs.",
//       },
//     ],
//     wargear: [
...
//         snippet:
//           "In addition, you gain +Rank bonus dice when Charging or making All-Out Attacks whilst wielding a weapon with the TRANSONIC Keyword.",
//       },
//     ],
//     wargear: [
//       { name: "Sicarian Battle Armour" },
...
//         snippet:
//           "As a Simple Action, you can Help all allies within 10m that have the ADEPTUS MECHANICUS Keyword, or are utilising equipment with a Machine Spirit (including guns and non-basic melee weapons), granting +Rank Bonus Dice to their Tests.",
//       },
//     ],
//     wargear: [
//       { name: "Omnissian Axe" },
...
//         options: [{ name: "Volkite Blaster" }, { name: "Eradication Ray" }],
//       },
//       {
//         name: "Macrostubber or Phosphor Serpenta",
//         selected: "Macrostubber",
//         options: [{ name: "Macrostubber" }, { name: "Phosphor Serpenta" }],
//       },
//       { name: "Light Power Armour" },
...
//         snippet:
//           "When you Test to discover the sins of another character (by coercion, investigation, or instinct), gain +Rank Bonus Dice.",
//       },
//       {
//         name: "Faithfull Replenishment",
//         snippet:
//           "During a Regroup, you can choose one character faithful to the Imperial Cult to regain all Shock.",
//       },
//     ],
//     wargear: wargearz(
//       "Ministorum Robes, Rosarius, Missionary Kit, Power Maul, Laspistol, Torture Kit, Ministorum Tomes, Portable Lectern"
//     ),
//     influence: 1,
//   },
//   // Abhumans
...
//         snippet:
//           "When using a weapon with the Sniper Weapon Trait, increase the weapon’s Sniper rating by +Rank. In addition, when you make a successful ranged Attack Test, you may immediately move up to your Speed as a Reflexive Action.",
//       },
//     ],
//     wargear: [
//       {
...
//         options: [{ name: "Ratling Rifle" }, { name: "Sniper Rifle" }],
//       },
//       { name: "Knife" },
//       { name: "Flak Armour" },
...
//         name: "Let It Rip",
//         snippet:
//           "When you Charge and have a ranged weapon, you can fire it wildly as a Free Action. This is treated as a Salvo Option that awards Bonus Dice to your Melee Attack Test equal to your weapon’s Salvo rating.",
//       },
//     ],
//     wargear: [
//       { name: "Flak Armour" },
...
//         selected:
//           "Slabshield and Grenadier Gauntlet OR Bullgryn Maul and Brute Shield",
//         options: [
//           { name: "Slabshield and Grenadier Gauntlet" },
...
//       {
//         type: "warning",
//         text: "The source (Forsaken System Player Guide) of this archetype is incomplete. The gaps are filled by the Shadow Tales Chapter Master.",
//       },
//     ],
//     influence: 1,
//     wargear: [
...
//       {
//         name: "Symbol of Authority",
//         variant: "Symbol of the Mechanicus & Inquisition",
//       },
//     ],
//     suggested: {
//       attributes: [],
...
//         snippet:
//           "To earn an Inquisitorial Rosette, the first skill you must master is to lay bare the sinful hearts of Human and xenos. When you succeed on a Test to acquire information from an individual, you gain free Shifts equal to your Rank.",
//       },
//     ],
//     influence: 1,
//     wargear: [
...
//       },
//     ],
//     wargear: [{ name: "Kroot Rifle" }, { name: "Kroot Armour" }],
//     suggested: {
//       attributes: [],
//       skills: [],
//       talents: ["core-brutalist", "core-die-hard", "core-fear"],
...
//       {
//         type: "info",
//         text: "This archetype has multiple weapon loadouts. See Affliction Ascendet, pg. 25.",
//       },
//     ],
//     archetypeFeatures: [
//       {
...
//     ],
//     wargear: wargearz(
//       "Terminator Armour, Storm Bolter, Power Sword or Power Fist, Crux Terminatus"
//     ),
//     influence: 2,
//   },
// ];
...
//         name: "Master of Warfare",
//         snippet:
//           "Psychic Powers may not target you. Powers that target or are cast from points within +Double Rank metres of you have their DN increased by +Double Rank, and always treat the Wrath Die as if it rolled a 1. Daemons within +Double Rank metres of you become Hindered (+Double Rank) until they leave this area.",
//       },
//     ],
//     wargear: wargearz(
//       "Vratine Power Armour, 3 Frag Grenades, 3 Krak Grenades or 1 Psyk-Out Grenade, Boltgun"
//     ),
//     influence: 0,
//   },
// ];
...
//         name: "Psyker",
//         snippet:
//           "A Scum Psyker begins play with one minor psychic " +
...
//         name: "Da Burna Dance",
//         snippet:
//           "You add +1 to Resolve for every creature you can see which is currently On Fire.",
//       },
//     ],
...
//     ],
//     wargear: wargearz(
//       "Kustom Mega Blasta, Choppa, 3 Stikkbomb, Ork Flak, Mek Toolz"
//     ),
//     influence: 1,
//   },
//   {
...
//     ],
//     wargear: wargearz(
//       "Rokkit Launcher, Ork Flak, 3 stikkbomb, 1 tankbusta bomb"
//     ),
//     influence: 1,
//   },
//   {
...
//     ],
//     wargear: wargearz(
//       "Eldar Mesh Armour, Shuriken Catapult, Mono Knife, 3 plasma grenade, spirit stone"
//     ),
//   },
//   {
//     name: "Bonesinger",
...
//         // TODO probably error
//         snippet:
//           "You are a psyker; you know the Smite and Vaul’s Song psychic powers and may learn other powers as described in Chapter 11.",
//         psychicPowers: [
//           {
//             name: "psykerSmite",
//             selected: "Smite",
...
//           },
//           {
//             name: "psykerVaulsSong",
//             selected: "Vaul´s Song",
//             query: { name: "Vaul´s Song" },
//             options: [],
//             free: true,
//           },
//         ],
...
//         name: "Unlock Disciplines",
//         snippet:
//           "You gain access to the Minor, Universal, Divination and Runes of Shaping Disciplines. You also gain access to one additional Discipline.",
//         description:
//           "<p>You gain access to the Minor, Universal, Divination and Runes of Battle Disciplines. You also gain access to on additional Discipline. See Chapter 11 for details.</p>",
//         selected: [""],
//         options: [
...
//     ],
//     wargear: wargearz(
//       "Rune armour, psytronome shaper, a set of wraithbone runes, Bonesinger shard, Spirit Stone"
//     ),
//     influence: 1,
//   },
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Inescapable Aim: You may reroll up to Double Rank dice on any Ranged Attack you make."
//       ),
//     ],
//     wargear: wargearz(
//       "Heavy Aspect Armour, Reaper Launcher, Dark Reaper Rangefinder, Mono Knife, spirit stone"
//     ),
//     influence: 1,
//   },
//   {
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Defensive Tactics: You add +Rank to your Defence. In addition, when an enemy Charges you, you may make a ranged attack against them as a Reflexive Action, adding +2 to the DN of the attack. This attack is resolved before the enemy moves."
//       ),
//     ],
//     wargear: wargearz(
//       "Aspect Armour, Avenger Shuriken Catapult, targeting vane, Mono Knife, 3 plasma grenade, spirit stone"
//     ),
//     influence: 2,
//   },
//   {
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Assured Destruction: When you attack a vehicle, structure, or monstrous creature, add +Rank ED to the attack. In addition, add +Rank to your resilience against attacks with the FIRE or MELTA keywords."
//       ),
//     ],
//     wargear: wargearz(
//       "Heavy Aspect Armour, Fusion Gun, 1 melta bomb, Mono Knife, spirit stone"
//     ),
//     influence: 1,
//   },
//   {
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Swift Death: When you Run, Charge, or Sprint, increase your Speed by +Rank. In addition, you may use Agility instead of Strength for your Athletics skill tests."
//       ),
//     ],
//     wargear: wargearz(
//       "Aspect Armour, shuriken pistol, power sword, Banshee Mask, spirit stone"
//     ),
//     influence: 1,
//   },
//   {
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Ride the Wind: You may reroll Double Rank dice on any Pilot test you make when operating an Aeldari Jetbike"
//       ),
//     ],
//     wargear: wargearz(
//       "Heavy Aspect Armour, Laser Lance, Aeldari Jetbike, spirit stone"
//     ),
//     influence: 1,
//   },
//   {
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Hunt in the Shadows: You may reroll up to Double Rank dice when making a Stealth test. In addition, you add +Rank bonus dice when you make a Surprise Attack."
//       ),
//     ],
//     wargear: wargearz(
//       "Heavy Aspect Armour, Scorpion Chainsword, Shuriken Pistol, Mandiblaster Helm, 3 plasma grenade, Spirit Stone"
//     ),
//     influence: 1,
//   },
//   {
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Flickerjump: As a Reflexive Action when a ranged attack is made against you, you may add +Double Rank to your Defence, as you use your Warp Jump Generator to flicker in and out of reality."
//       ),
//     ],
//     wargear: wargearz(
//       "Heavy Aspect Armour, Death Spinner, Warp Jump Generator, Mono Knife, spirit stone"
//     ),
//     influence: 1,
//   },
//   // Harlequin
...
//     ],
//     wargear: wargearz(
//       "Holo-suit, Agaith, Flip-Belt, Harlequins Blade, Shuriken Pistol, 3 Plasma Grenades"
//     ),
//     influence: 3,
//   },
//   {
...
//             snippet:
//               "Harlequin allies within 6 metres of you add +Rank ED to their melee attacks.",
//           },
//           {
//             name: "Prince of Light",
//             snippet:
//               "When you or any HARLEQUIN allies within 6 metres Charge, you increase your total movement by +Rank.",
//           },
//           {
//             name: "Darkness Bite",
//             snippet:
//               "After you make a melee attack, you may inflict a number of Mortal Wounds equal to your Rank, allocated amongst any enemies you hit during your attack.",
//           },
//           {
//             name: "Twilight Grasp",
//             snippet:
//               "When you make a melee attack against an enemy which is not a Vehicle or Monstrous Creature, your melee weapon gains the Warp Weapon trait.",
//           },
//         ],
//       },
//     ],
...
//           "You add +Rank to Speed, and enemies may never attempt a Reflexive Attack against you when you move out of Engagement."
//         ),
//         modifications: [
//           {
//             targetGroup: "traits",
...
//             snippet:
//               "Allies within 6 metres of you add +Rank to their Resilience.",
//           },
//           {
//             name: "Veil of Illusion",
//             snippet:
//               "Whenever a ranged attack targets an ally within 6 metres of you, the attacker counts the range to their attacker as being +Triple Rank metres longer than it actually is.",
//           },
//           {
//             name: "Gloomwake",
//             snippet:
//               "Allies within 6 metres of you receive +Rank Defence against ranged attacks. This is considered to be a bonus from Cover.",
//             modifications: [
//               {
//                 targetGroup: "traits",
//                 targetValue: TRAITS.DEFENCE,
//                 modifier: 0,
//                 rank: 1,
//                 condition: "you and allies within 6m, against ranged attacks.",
//               },
//             ],
//           },
//           {
...
//             snippet:
//               "Enemies within 6 metres of you add +Rank to the DN of all melee attacks they make.",
//           },
//         ],
//       },
//       {
//         name: "Psyker",
//         snippet:
//           "You are a Psyker, and you know the Smite psychic power. You may learn additional psychic powers from the Divination, Telepathy, and Phantasmancy disciplines.",
//         psychicPowers: [
//           {
//             name: "psykerSmite",
//             selected: "Smite",
...
//     ],
//     wargear: wargearz(
//       "Holo-suit, Agaith, flip-belt, miststave, shuriken pistol, pack grenade launcher, 6 hallucinogen grenades"
//     ),
//     influence: 4,
//   },
//   {
...
//             snippet:
//               "Damage rolls you make against enemies who are currently suffering from the effects of Fear, Terror, or Pinning add +Rank ED.",
//           },
//           {
//             name: "Harvester of Torment",
//             snippet:
//               "When you make a successful ranged attack against a Mob, you count as scoring +Double Rank additional Icons when determining how many of the Mob you hit.",
//           },
//           {
//             name: "The Jest Inescapable",
//             snippet:
//               "Add +6 to the short range of your ranged weapon, +12 to the medium range, and +18 to the long range. In addition, the weapon gains the Mortal [1] trait.",
//           },
//           {
//             name: "Humbling Cruelity",
//             snippet:
//               "Your ranged weapon gains the Inflict [Pinned] trait, and enemies add your Rank to the DN of tests to resist being Pinned or to recover from pinning.",
//           },
//         ],
//       },
//     ],
//     wargearString:
//       "Holo-suit, Agaith, Flip-Belt, Master-Crafted Shuriken Cannon, 3 Shrieker Bio-Explosive Discs",
//     wargear: [
//       { name: "Holo-suit" },
//       { name: "Agaith" },
//       { name: "Flip-Belt" },
...
//             name: "Blitz",
//             snippet:
//               "At the start of one of your turns, you may choose to initiate a Blitz. When you do so, your Speed is doubled, and you ignore Double Rank DN increases on Multi-Attacks until the end of your turn. Once you have done this, you cannot do so again until after your next Regroup.",
//           },
//           {
...
//             name: "Chromatic Rush",
//             snippet:
//               "Your speed is increased by +Double Rank instead of +Rank.",
//             modifications: [
//               {
//                 targetGroup: "traits",
//                 targetValue: TRAITS.SPEED,
...
//             snippet:
//               "Your Defence is increased by +Double Rank instead of +Rank.",
//             modifications: [
//               {
//                 targetGroup: "traits",
//                 targetValue: TRAITS.DEFENCE,
...
//     ],
//     wargear: wargearz(
//       "Holo-suit, Agaith, flip-belt, Harlequins Caress, Harlequins Kiss"
//     ),
//   },
//   // druchari
//   {
...
//         name: "Tormentor",
//         snippet:
//           "You add +Double Rank bonus dice to all Intimidation Interaction attacks you make.",
//       },
//     ],
...
//         snippet:
//           "As long as you are not immobilised or Restrained, you may use Agility instead of Toughness when you roll Determination, and you may roll Determination against Mortal Wounds. In addition, enemies attempting to Fall Back must pass an Agility test (DN 2+ Double Rank); failure means that they cannot Fall Back this turn.",
//       },
//     ],
//     wargear: wargearz(
//       "Wychsuit, Hekatarii blade, splinter pistol, 3 plasma grenade, 3 Hekatarii Combat Drugs"
//     ),
//   },
//   {
//     name: "Incubus",
...
//         snippet:
//           "For each Exalted Icon you roll on the damage roll for a melee attack, you may roll one additional ED. These additional ED cannot themselves allow you to roll extra ED.",
//       },
//     ],
...
//     ],
//     wargear: wargearz(
//       "Bolt Pistol, Power Axe, augmetic servo-arm, Ionclad Carapace Armour, Refractor Field, combi-tool"
//     ),
//   },
//   {
//     name: "Hearthguard",
...
//     ],
//     wargear: wargearz(
//       "Bolter, Power Axe, Bolt Pistol, Mono Knife, Ionclad Carapace Armour, 3 frag grenade, 3 krak grenade"
//     ),
//   },
//   {
//     name: "Ancestor Lord",
...
//     ],
//     wargearString:
//       "Ionclad Carapace armour, ancestor’s robes (clothing), Master-Crafted Force Stave, Master-Crafted Bolt Pistol.",
//     wargear: [
...
//     ],
//     wargearString:
//       "Arbites Carapace, combat shotgun or shock maul and suppression shield, magnacles, Book of Judgement (abridged).",
//     wargear: [
...
//     ],
//     wargearString:
//       "Flak coat, stubber, auto-quill, Data-Slate, Book of Judgement (abridged)",
//     wargear: [
//       { name: "Flak Coat" },
//       { name: "Auto-Quill" },
//       { name: "Data-Slate" },
...
//     ],
//     wargear: wargearz(
//       "Arbites Carapace, Shock Maul, Combat Shotgun, magnacles, medkit, Book of Law/Book of Law (abridged)"
//     ),
//   },
//   {
//     name: "Detective",
...
//     ],
//     wargearString:
//       "Flak coat, combi-tool, any one ranged weapon of uncommon or lower rarity, knife, auspex, three sets of clothing for use in disguises, symbol of authority, vox caster.",
//     wargear: [
//       { name: "Flak coat" },
//       { name: "combi-tool" },
//       {
...
//     ],
//     wargear: wargearz(
//       "Bodyglove, clothing, Laspistol, knife, Auspex, data-slate, Preysense goggles, Memorance Implant"
//     ),
//   },
// ];
...
//         ...simpleAbility(
//           "Bestial Zealotry",
//           "When you can see an enemy (either an obvious foe, or a creature identified as an enemy by an ally or superior), you add +Rank to your Resolve, and add +Rank bonus dice to any melee attacks you make when you charge."
//         ),
//         modifications: [
//           {
//             targetGroup: "traits",
...
//             modifier: 0,
//             rank: 1,
//             condition: "when you can see your enemy.",
//           },
...
//     ],
//     wargearString:
//       "Two melee weapon s each of Value 3 or less of up to Common rarity, primitive armour",
//     wargear: [
...
//             modifier: 0,
//             rank: 2,
//             condition: "when treating a Dying character.",
//           },
//         ],
//       },
//     ],
...
//     ],
//     wargear: wargearz(
//       "Flak armour, Refractor Field, Laspistol, chainsword, knife, Munitorum-Issue Mess Kit/guard issue mess kit, blanket, grooming kit, Uplifting Primer, 3 ration packs"
//     ),
//   },
// ];
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Hellblaster Focus: When you make an attack with a Plasma weapon, you may re-roll up to Double Rank dice."
//       ),
//     ],
//     wargear: wargearz(
//       "Tacticus Mk X/Mark X Tacticus Power Armour, Plasma Incinerator, Heavy Bolt Pistol, Astartes Combat Knife, 3 frag grenade, 3 krak grenade"
//     ),
//   },
//   {
//     ...archetype(
...
//       simpleAbility(
//         "Meteoric Descent",
//         "You run, sprint, or charge using your jump pack, any enemy within 2m of the point where you landed must pass an Agility test (DN 2+Rank) or be knocked prone and suffer a Mortal Wound."
//       ),
//       simpleAbility(
//         "Guns Blazing",
//         "When you wield a pair of Assault Bolters or Plasma Exterminators, you may benefit from the Dual Wield or Simultaneous Strike talents even though those weapons lack the Pistol trait."
//       ),
//     ],
//     wargearString:
...
//       simpleAbility(
//         "Terror Troops",
//         "When you charge an enemy who was unaware of you before you charged, they must make a Fear test with a DN equal to your Stealth Score."
//       ),
//     ],
//     wargearString:
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Close Quarters Assault: When making a melee attack, or a ranged attack at short range, against an enemy in cover, an Incursor may re-roll up to Rank dice."
//       ),
//     ],
//     wargearString:
...
//       {
//         name: "Astartes Combat Knife",
//         variant: "Two Astartes combat knives (with Matched Pair upgrade)",
//       },
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Voxbane: When you make a Tech interaction attack against an enemy, the range of the attack is increased by 1+Double Rank."
//       ),
//     ],
//     influence: 1,
//     wargearString:
...
//         options: [
//           {
//             name: "Auto-Boltstorm Gauntlet",
//             variant: "Paried Auto Boltstorm Gauntlets",
//           },
//           {
//             name: "Flamestorm Gauntlets",
//             variant: "Paried Flamestorm Gauntlets",
//           },
//         ],
//       },
//     ],
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Precision Shots: When you aim, you add +Rank bonus dice onto the following ranged attack, in addition to the other benefits of aiming."
//       ),
//     ],
//     wargearString:
...
//         selected: "",
//         options: [{ name: "Bolt Sniper Rifle" }, { name: "Las Fusil" }],
//       },
//     ],
//   },
//   {
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Guard Thy Brethren: Whenever you succeed at a Medicae test upon a Dying ally with the ADEPTUS ASTARTES keyword, gain 1 Wrath. In addition, you gain +Rank to Resolve and Determination while you can see or hear one or more Dying Adeptus Astartes allies."
//       ),
//     ],
//     wargear: wargearz(
//       "Tacticus Mk X/Mark X Tacticus Power Armour, Absolvor Bolt Pistol, Narthecium, Reductor, 3 Frag Grenade, 3 Krak Grenade"
//     ),
//   },
//   {
//     ...archetype(
...
//     keywords:
//       "Imperium, Adeptus Astartes,[Chapter], Adeptus Mechanicus, Cult Mechanicus, Primaris",
//     archetypeFeatures: [
//       simpleAbility(
//         "Hymn of Reforging: You receive +Double Rank to Tech tests to repair damaged machinery. All Tech tests you make take half the standard time."
//       ),
//     ],
//     influence: 2,
//     wargearString:
...
//       simpleAbility(
//         "Spiritual Leaders",
//         "You, and all allies with the IMPERIUM keyword within 15+Rank metres add +Rank to Resolve. This increases to +Double Rank if they share your [CHAPTER] keyword."
//       ),
//     ],
//     wargear: wargearz(
//       "Tacticus Mk X/Mark X Tacticus power armour, Absolver Bolt Pistol, Crozius Arcanum, 3 Frag Grenade, 3 Krak Grenade, Rosarius"
//     ),
//   },
//   {
//     ...archetype(
...
//         name: "Unlock Disciplines",
//         snippet:
//           "You gain access to the Minor and Universal Disciplines. You unlock an addtional single Psychic Discipline: Divination, Pyromancy, Telekinesis, Telepathy, Maleficarum, Librarius, or a discipline unique to your Chapter",
//         description:
//           "<p>You gain access to the Minor and Universal Disciplines. You unlock an additional single Psychic Discipline: Divination, Pyromancy, Telekinesis, Telepathy, Maleficarum, Librarius, or a discipline unique to your Chapter.</p>",
//         selected: [""],
//         options: [
//           // { key: 'core-minor', name: 'Minor', modifications: [{ targetGroup: 'psychicDisciplines', targetValue: 'Minor' }] },
//           // { key: 'core-universal', name: 'Universal', modifications: [{ targetGroup: 'psychicDisciplines', targetValue: 'Universal' }] },
...
//             name: "Librarius",
//             modifications: [
//               { targetGroup: "psychicDisciplines", targetValue: "Librarius" },
//             ],
//           },
...
//     ],
//     wargear: wargearz(
//       "Tacticus Mk X/Mark X Tacticus power armour, Heavy Bolt Pistol, Force Sword, 3 Frag Grenade, 3 Krak Grenade, Psychic Hood"
//     ),
//   },
// ];
...
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Bolt Pistol, Chainsword, Jump Pack, 3 Frag Grenade, 3 Krak Grenade"
//     ),
//   },
//   {
//     ...archetype(
...
//     keywords:
//       "Imperium,Adeptus Astartes,Grey Knights,Psyker,Inquisition, Ordo Malleus",
//     influence: 1,
//     archetypeFeatures: [
//       {
//         name: "Psyker",
//         snippet:
//           "You are a Psyker; you begin play with the Rites of Banishment psychic power. You may purchase additional powers from the Sanctic discipline.",
//         description:
...
//         psychicPowers: [
//           {
//             name: "psykerRitesOfBanishment",
//             selected: "Rites of Banishment",
//             query: { name: "Rites of Banishment" },
//             options: [],
//             free: true,
//           },
//           {
...
//       {
//         name: "Liber Daemonica",
//         variant: "Armoured copy of the liber daemonica",
//       },
//     ],
//   },
//   {
...
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Bolt Pistol, Chainsword, Narthecium, Reductor, 3 Frag Grenade, 3 Krak Grenade"
//     ),
//   },
//   {
//     ...archetype(
...
//     hint: "A warrior-savant initiated into the mysteries of the Machine Cult.",
//     keywords:
//       "Imperium, Adeptus Astartes,[Chapter], Adeptus Mechanicus, Cult Mechanicus",
//     archetypeFeatures: [
//       simpleAbility(
//         "Rite of Repair: You receive +Double Rank to Tech tests to repair damaged machinery. All Tech tests you make take half the standard time."
//       ),
//     ],
//     wargearString:
...
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Bolt Pistol, Crozius Arcanum, 3 Frag Grenade, 3 Krak Grenade, Rosarius"
//     ),
//   },
//   {
//     ...archetype(
...
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Bolt Pistol, Force Staff, 3 Frag Grenade, 3 Krak Grenade, Psychic Hood"
//     ),
//   },
...
//         snippet:
//           "You add +Rank ED to all damage rolls and +Double Rank to damage value of unarmed strikes. You may substitute Agility for Toughness for Determination. You may roll Determination against Mortal Wounds.",
//         description:
...
//         snippet:
//           "When disguised or otherwise concealing your identity, you gain a Stealth Score based on the total of your Deception test. This score only decreases when you take actions which may reveal your true intentions (GM’s discretion).",
//         description:
...
//     influence: 0,
//     wargear: wargearz(
//       "C’Tan Phase Sword, Neural Shredder, 2 Polymorphine, 3 poisoned mono-knive, bodyglove"
//     ),
//   },
//   {
...
//         name: "Life Drain",
//         snippet:
//           "Enemies engaged with you at the end of their turn must pass a Willpower test (DN 2+Rank) or suffer Shock equal to your Rank. PSYKERS suffer Double Rank shock damage instead.",
//         description:
...
//     influence: 0,
//     wargear: wargearz(
//       "Etherium, Force Matrix, Animus Speculum, 3 Psyk-Out Grenade, Bodyglove"
//     ),
//     description:
...
//         snippet:
//           "When you suffer one or more Wounds in melee, roll 1d6; on a 4+, the attacker suffers a Mortal Wound. If you are killed, you detonate, inflicting 10+4ED damage with AP-2 to everything within a number of metres equal to your Toughness.",
//         description:
...
//     influence: 0,
//     wargear: wargearz(
//       "Augmetic viscera, cardioproxy, reflex catalyst, sinew armature, executor pistol, sentinel array, neuro-gauntlet, power sword, 2 melta bomb, Eversor combat drugs, Bodyglove"
//     ),
//   },
//   {
...
//         name: "Perfect Shot",
//         snippet:
//           "When you aim with a ranged weapon, you double the listed Range of the weapon, and you add +Rank bonus dice to the subsequent ranged attack.",
//         description:
...
//     influence: 0,
//     wargear: wargearz(
//       "Exitus Longrifle, Exitus Pistol, Exitus Hellfire Rounds, Exitus Shield-breaker Rounds, Exitus Turbo-Penetrator Rounds, Vindicare Stealth Suit, Vindicare Spy Mask"
//     ),
//   },
// ];
...
//         ...simpleAbility(
//           "Fevour",
//           "When within hearing range of a character with the ADEPTUS MINISTORUM keyword, you increase your Resolve by +Rank. In addition, if that Adeptus Ministorum character has suffered any wounds during the current scene, your Determination is increased by +Rank while you remain within 10 metres of them."
//         ),
//         modifications: [
//           {
//             targetGroup: "traits",
...
//             rank: 1,
//             condition:
//               "when in hearing range of another ADEPTUS MINISTORUM character.",
//           },
//           {
//             targetGroup: "traits",
...
//             rank: 1,
//             condition:
//               "when an ADEPTUS MINISTORUM character within hearing range suffere any wound during this combat and you are witin 10m.",
//           },
//           // XXX { targetGroup: 'combat', targetValue: 'meleeAttacks', modifier: 0, rank: 1, condition: 'when you can see charge.' },
//         ],
//       },
//     ],
//     wargearString:
//       "One ranged or melee weapon of Value 3 or less of up to Common rarity, knife, symbol of devotion (tin aquila, devotional scroll, etc.).",
//     wargear: [
//       {
...
//     ],
//     wargearString:
//       "Laspistol, one melee weapon or one ranged weapon of up to Value 7 and a rarity of up to Rare, Rosarius, knife, clothing (Ministorum robes), missionary kit, symbol of authority.",
//     wargear: [
//       { name: "Laspistol" },
//       {
...
//         ...simpleAbility(
//           "Sanctified Linguist",
//           "You add +Rank bonus dice on Scholar tests relating to language, and you know Double Rank additional languages. You also gain +Rank Conviction."
//         ),
//         modifications: [
//           {
//             targetGroup: "skills",
...
//             modifier: 0,
//             rank: 1,
//             condition: "when related to language",
//           },
//           {
//             targetGroup: "traits",
//             targetValue: TRAITS.CONVICTION,
//             modifier: 0,
//             rank: 1,
//           },
//         ],
...
//     ],
//     wargearString:
//       "Sororitas power armour, bolt pistol, copy of the Rule of the Sororitas, collection of reference texts, vox caster, laud hailer.",
//     wargear: [
//       { name: "Sororitas power armour" },
//       { name: "Bolt Pistol" },
//       {
...
//         ...simpleAbility(
//           "Spiritual Advisor",
//           "You add +Rank bonus dice to Leadership and Persuasion tests when interacting with the Nobility of the Imperium. You also add +Rank to your Conviction."
//         ),
//         modifications: [
//           {
//             targetGroup: "skills",
...
//             modifier: 0,
//             rank: 1,
//             condition: "when interacting with imperial nobility.",
//           },
//           {
//             targetGroup: "skills",
//             targetValue: SKILLS.PERSUASION,
...
//     ],
//     wargearString:
//       "Formal Sororitas Robes (clothing), bodyglove, Laspistol, Mono Knife, Chaplet Ecclesiasticus, copy of Rule of the Sororitas.",
//     wargear: [
//       { name: "Laspistol" },
//       { name: "Bodyglove" },
...
//       },
//     ],
//     wargearString: "Eviscerator, clothes (tattered penitent robes).",
//     wargear: [
//       { name: "Eviscerator" },
...
//       simpleAbility(
//         "Fanatical Devotion",
//         "You add +Double Rank bonus dice to Determination rolls, and you do not suffer any Shock when you roll Determination."
//       ),
//     ],
//     wargearString:
//       "Luminen capacitor, electrostatic gauntlets, Voltagheist field generator, any two augmetics.",
//     wargear: [
...
//     ],
//     wargearString:
//       "Luminen capacitor, Electroleech staff, Voltagheist field generator, any two augmetics.",
//     wargear: [
//       { name: "Luminen capacitor" },
...
//         "You do not bleed (making you immune to Bleeding), and you add +Rank to your Maximum Wounds and Maximum Shock."
//       ),
//     ],
//     wargearString:
//       "Sicarian battle-armour, stubcarbine and power sword or flechette blaster and taser goad, Augmetic Arms (two), data-tether, augmetic legs, augmetic viscera, Neurostatic projector",
//     wargear: [
//       { name: "Sicarian battle-armour" },
//       {
...
//     keywords:
//       "Imperium, Adeptus Mechanicus, Cult Mechanicus, [Forge World], Skitarii",
//     influence: 1,
//     archetypeFeatures: [
//       simpleAbility(
//         "More Machine Than Man",
...
//     ],
//     wargear: wargearz(
//       "Sicarian battle-armour, transonic razor and chordclaw or transonic blade and transonic blade, Augmetic Arm, Augmetic Arm, data-tether, augmetic legs, augmetic viscera"
//     ),
//   },
//   {
//     name: "Transmechanic",
...
//       simpleAbility(
//         "Infovore",
//         "You may reroll up to Double Rank dice on Investigation and Scholar tests, and such tests take you only half as long to perform."
//       ),
//     ],
//     wargearString:
//       "Calculus Logi implant, one optical or utility Mechadendrite, any two Augmetics, mesh armour, laspistol.",
//     wargear: [
...
//       simpleAbility(
//         "Magos Biologis",
//         "You add +Rank bonus dice to any Medicae test you attempt and take only half as long to perform a Medicae test. In addition, your bioengineered and genetic augmentations increase your Max Wounds and Max Shock by +Rank."
//       ),
//     ],
//     wargearString:
//       "Omnissian Axe, Augur Array (diagnostor), Medicae Mechadendrite, any two augmetics, any one cybernetic of up to Availability 7 (Unique), light power armour, and any one weapon of up to Availability 6 (Very Rare).",
//     wargear: [
//       { name: "Omnissian Axe" },
...
//       simpleAbility(
//         "Technoprophet",
//         "You may purchase psychic powers from the Divination discipline even though you are not a Psyker. Using these powers requires an Investigation test in place of a Psychic Mastery test, and you do not choose a power level. Use of these abilities is not considered a psychic power. A Complication that results from one of these abilities inflicts 1d3+1 Shock, due to logic errors and paradoxical outcomes."
//       ),
//     ],
//     wargearString:
//       "Omnissian Axe, Calculus Logi implant, any 3 augmetics, any one cybernetic of up to Availability 7 (Unique), light power armour, and any one weapon of up to Availability 6 (Very Rare).",
//     wargear: [
//       { name: "Omnissian Axe" },
//       { name: "Calculus Logi implant" },
//       { name: "light power armour" },
...
//       simpleAbility(
//         "Forge-Lord",
//         "You halve the time it takes to attempt any Tech test, and you add +Double Rank bonus dice to interact with machinery. In addition, as a Simple Action you may invoke one of the Canticles of the Omnissiah (see AAOA, pg. 96)."
//       ),
//       {
...
//     ],
//     wargearString:
//       "Omnissian Axe, augmetic servo-arm, any two augmetics, any two cybernetics of up to Availability 7 (Unique), light power armour, and any two weapons of up to Availability 7 (Unique).",
//     wargear: [
//       { name: "Omnissian Axe" },
//       { name: "Mechadendrites (Servo-Arm)" },
//       { name: "Light Power Armour" },
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Masters of Slaughter: The cruelty and malice of a Chaos Space Marine knows no limit, and few can endure their wrath. When making a critical hit, they count as improving the severity of the critical hit as if they had spent one Glory. They may still spend additional Glory to increase the severity further."
//       ),
//     ],
//     wargearString:
...
//         options: [{ name: "Boltgun" }, { name: "Chainsword" }],
//       },
//       { name: "Bolt Pistol" },
//       { name: "Astartes Combat Knife" },
//       { name: "Frag Grenade", amount: 3 },
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Cruel Hunters: Enemies within 15m of a Chaos Space Marine Raptor add +½ Rank to the DN of any Resolve tests they are required to make."
//       ),
//     ],
//     wargearString:
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Addicted to Destruction: When a Chaos Space Marine Havoc rolls a 6 on their Wrath die when making a ranged attack, they may forego their critical hit and spend a reload in order to make a second ranged attack with that weapon. This second attack may not allow them to make any additional attacks."
//       ),
//     ],
//     wargearString:
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Blood for the Blood God!: When a Khorne Berzerker makes an All-Out Attack, they may choose up to ½ Rank dice in their dice pool to be Wrath dice, in addition to the normal Wrath die. If any of these Wrath dice are 6s, then the character scores a critical hit. They gain one level of extra severity on that critical hit, as if a Glory had been spent, for every Wrath die after the first which rolls a 6."
//       ),
//     ],
//     wargearString:
...
//         options: [{ name: "Chainsword" }, { name: "chain axe" }],
//       },
//       { name: "Bolt Pistol" },
//       { name: "Frag Grenade", amount: 3 },
//       { name: "Krak Grenade", amount: 3 },
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Disgustingly Resilient: Plague Marines are extraordinarily durable, as they feel no pain and they draw their nauseating vitality from their patron god. A Plague Marine may Soak mortal wounds and does not cost them any Shock."
//       ),
//       {
...
//         options: [{ name: "Bolt Gun" }, { name: "Sonic Blaster" }],
//       },
//       { name: "Astartes Combat Knife" },
//       { name: "Frag Grenade", amount: 3 },
//       { name: "Krak Grenade", amount: 3 },
...
//     ],
//     keywords:
//       "Heretic, Chaos, [Mark of Chaos], Heretic Astartes, [Legion], Psyker",
//     influence: 3,
//     modifications: [
//       { targetGroup: "traits", targetValue: TRAITS.CORRUPTION, modifier: 3 },
//     ],
...
//         name: "Psyker",
//         snippet:
//           "You learn the Smite power and one additional minor power. You gain access to Minor and Universal powers. You also gain access to either Librarius or Chapter specifc powers",
//         description:
...
//       simpleAbility(
//         "Hatred of Khorne",
//         "Sorcerers may never choose the Khorne keyword."
//       ),
//     ],
//     wargearString:
...
//     ],
//     keywords:
//       "Heretic, Chaos, [Mark of Chaos], Heretic Astartes, [Legion], Dark Mechanicus",
//     influence: 1,
//     modifications: [
//       { targetGroup: "traits", targetValue: TRAITS.CORRUPTION, modifier: 3 },
//     ],
//     archetypeFeatures: [
//       simpleAbility(
//         "Master of Mechanisms: Warpsmiths automatically reduce the time by half for any Tech test. They receive +Rank on any test to summon or bind a daemon into a machine, or to command a daemonic machine."
//       ),
//     ],
//     wargearString:
...
//     ],
//     keywords:
//       "Heretic, Chaos, [Mark of Chaos], Heretic Astartes, [Legion], Priest",
//     influence: 3,
//     modifications: [
//       { targetGroup: "traits", targetValue: TRAITS.CORRUPTION, modifier: 3 },
//     ],
//     archetypeFeatures: [
//       simpleAbility(
//         "Demagogue: A Chaplain, and all allies with the Chaos keyword within 15+Rank metres, may add +Rank to their Resolve."
//       ),
//     ],
//     wargearString:
...
//     archetypeFeatures: [
//       simpleAbility(
//         "The Scent of Blood: After an enemy has been killed in a scene, a Khorngor becomes frenzied, and must make WP tests to restrain themselves. While frenzied, however, they add +½ Rank ED to all melee damage rolls they make."
//       ),
//     ],
//     wargearString: "Two axes, or chainaxe and Autopistol, flak armour",
//     wargear: [
//       { name: "Flak Armour" },
//       {
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Inured to Suffering: Pestigor know no pain or fear, and little can dissuade them from their task. They increase both their Resolve and their Soak by +½ Rank."
//       ),
//     ],
//     wargearString: "Autogun, plague knife, flak armour",
//     wargear: [
//       { name: "Flak Armour" },
//       { name: "Autogun" },
//       { name: "Plague Knife" },
...
//     archetypeFeatures: [
//       simpleAbility(
//         "Distracting Musk: Slaangor exude a faintly soporific musk that disrupts the concentration of any who stray too close. Characters within 5m of a Slaangor increase the DN of all Willpower and Resolve tests by ½ Rank. This does not affect characters with the Slaanesh keyword, who’ve already built up a resistance to it."
//       ),
//     ],
//     wargearString: "Two swords, mesh armour.",
//     wargear: [{ name: "Mesh Armour" }, { name: "Sword" }, { name: "Sword" }],
//   },
//   {
...
//         name: "Aura of Change",
//         snippet:
//           "Your Resilience increases by +Rank, and you make roll Determination against Mortal Wounds. In addition, gain +1d3 Corruption.",
//         modifications: [
//           {
//             targetGroup: "traits",
//             targetValue: TRAITS.RESILIENCE,
...
//       },
//     ],
//     wargearString: "Two swords, or chainsword and autopistol.",
//     wargear: [
//       {
...
//     keywords:
//       "Imperium, Adeptus Astra Telepathica, Silent Sisterhood, Talons of the Emperor",
//     influence: 2,
//     modifications: [],
//     archetypeFeatures: [
//       {
//         name: "Witch Hunter",
//         snippet:
//           "You add +Rank ED to all attacks you make against creatures with the PSYKER keyword.",
//         modifications: [],
//       },
//     ],
//     wargearString:
...
//         name: "Ex Oblivio",
//         snippet:
//           "For the purposes of your Pariah species abilities, and any Pariah-specific talents you possess, your Willpower is increased by +Rank. Additionally, for the purposes of Pariah species abilities or Pariah-specific talents, your Rank is counted as 1 higher than normal.",
//         modifications: [],
//       },
//     ],
//     wargearString:
...
//       {
//         name: "Executioner Greatblade",
//         variant: "Master-Crafted Executioner Greatblade",
//       },
//       { name: "Mastercrafted" },
//     ],
//   },
...
//         snippet:
//           "You are used to laying down consistent, deadly volleys of fire. When you make a ranged attack with a PULSE weapon, and did not move during your turn, you may increase the weapon’s Salvo rating by +Rank.",
//       },
//     ],
//     wargear: wargearz(
//       "T’au Body Armour, Pulse Rifle or Pulse Carbine, 3 Photon Grenades"
//     ),
//   },
// ];
...
//         name: "Focus Fire",
//         snippet:
//           "Devastator Marines are known for their ability to lay down waves of suppressive fire, cutting down any enemy foolish enough to approach them. They add +Rank bonus dice to hit with weapons with the Heavy trait, but only if they did not move that turn.",
//       },
//     ],
//     wargearString:
...
//         snippet:
//           "An Assault Marine uses his jump pack to its fullest potential, using his momentum as a weapon. After charging while equipped with a jump pack, an Assault Marine may add +Rank ED to any melee attacks he makes that round.",
//       },
//     ],
//     wargearString:
...
//         snippet:
//           "A Techmarine gains +Rank to all Scholar, Pilot and Tech tests involving vehicles, weapons, armor, and wargear with the Adeptus Astartes keyword and +½ Rank to all other Imperium items.",
//       },
//     ],
//     wargearString:
...
//         options: [{ name: "Bolt Pistol" }, { name: "Boltgun" }],
//       },
//       { name: "Omnissian Axe" },
//       { name: "Mechadendrites (Servo-Arm)" },
//       { name: "Frag Grenade", amount: 3 },
...
//         name: "Prime Helix",
//         snippet:
//           "An Apothecary adds +½ Rank to the number of wounds he heals when performing first aid. He gains +Rank bonus dice to all Scholar and Medicae tests he makes regarding Adeptus Astartes or Primaris Astartes. An Apothecary will never willingly leave recoverable gene-seed behind, and is duty-bound to recover any that can be.",
//       },
//     ],
//     wargearString:
...
//         name: "Psyker",
//         snippet:
//           "You gain the Smite Power and one Minor or Librarius Power. You gain access To Minor, Universal and Librarius powers.",
//         description:
...
//           },
//           {
//             name: "psykerMinorOrLibrarius",
//             selected: "",
//             query: { discipline: "Minor,Librarius" },
//             options: [],
//             free: true,
//           },
//         ],
...
//         snippet:
//           "Marines from the Black Templars Chapter may not choose this Archetype.",
//       },
//     ],
//     wargearString:
...
//         options: [{ name: "Force Sword" }, { name: "Force Staff" }],
//       },
//       { name: "Frag Grenade", amount: 3 },
//       { name: "Krak Grenade", amount: 3 },
//     ],
...
//         ...simpleAbility(
//           "Take Everything!",
//           "The Raider gains +Rank to all Pilot tests. They also begin each game session with one additional Reload."
//         ),
//       },
//     ],
//     modifications: [
...
//     ],
//     wargear: wargearz(
//       "Lasgun or Hand Flamer, Mono Knife or Sword, 2 Throwing Knifes, 1 Frag Grenade, Mesh Armour"
//     ),
//     influence: 1,
//   },
//   {
...
//         ...simpleAbility(
//           "Favour of the Gods",
//           "You start each session with an additional point of Wrath. You also gain a Wrath point when you kill a creature with the IMPERIUM Keyword."
//         ),
//       },
//     ],
//     modifications: [
...
//     ],
//     wargear: wargearz(
//       "Flak Armour, Chain Axe or Chain Sword, Bolt Pistol, 2 Frag Grenades, 1 krak Grenade"
//     ),
//     influence: 2,
//   },
//   {
...
//         ...simpleAbility(
//           "Demagogue",
//           "You gain +Rank on all Leadership and Persuasion tests."
//         ),
//         modifications: [
//           {
//             targetGroup: "skills",
...
//     ],
//     wargear: wargearz(
//       "Duelling Las Pistol, Mono Knife, Refractor Field, Heretical Texts, Fine Robes"
//     ),
//     influence: 2,
//   },
//   {
...
//         ...simpleAbility(
//           "Abnormal Physiology",
//           "The marine is immune to all diseases, poisons, and automatically passes any test that would case FEAR. You also gain +Rank bonus when using Intimidation or any effect that instills FEAR."
//         ),
//         modifications: [
//           {
//             targetGroup: "skills",
...
//     ],
//     wargear: wargearz(
//       "Plague Marine Armour, Boltgun, Bolt Pistol, Plague Knife, 3 frag grenades, 3 tox grenades"
//     ),
//     influence: 1,
//   },
//   {
...
//         ...simpleAbility(
//           "More Blood!",
//           "Increase the berserkers speed by 2 when they charge. You do not suffer a penalty when wounded and instead gain +Rank bonus to all Weapon Skill and Resolve tests"
//         ),
//         modifications: [
//           {
//             targetGroup: "traits",
...
//           {
//             targetGroup: "skills",
//             targetValue: SKILLS.WEAPON_SKILL,
//             modifier: 0,
//             rank: 1,
//             condition: "when wounded",
//           },
//           {
//             targetGroup: "traits",
//             targetValue: TRAITS.RESOLVE,
...
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Chain Axe or Chain Sword, Bolt Pistol, Astartes Combat Knife, 3 frag grenades, 3 krak grenades"
//     ),
//     influence: 1,
//   },
//   {
...
//         ...simpleAbility(
//           "New Sensations",
//           "The Gamemaster must spend 2 Ruin o Seize the initative while you are in the necounter. In Addition, once per combat encounter the Noise Marine may seize the initiative without spending a point of Glory."
//         ),
//       },
//     ],
//     modifications: [
...
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Noise Marine Sonic Blaster, Bolt Pistol, Astartes Combat Knife, 3 frag grenades, 3 concussion grenades"
//     ),
//     influence: 2,
//   },
//   {
...
//         ...simpleAbility(
//           "Arcane Secrets",
//           "The Character gains the PSYKER keyword and starts the game with one minor Psychic Power and Smite. When performing a Ritual they may reroll a number of failed dice equal to Rank. Complications cannot be rerolled. If they already posses the PSYKER keyword, the start with an additional minor power."
//         ),
//         psychicPowers: [
//           {
//             name: "psykerSmite",
...
//     ],
//     wargear: wargearz(
//       "Aquila Mk VII/Aquila Power Armour, Force Axe or Force Sword, Boltgun, Astartes Combat Knife, PSychic Focus"
//     ),
//     influence: 1,
//   },
// ];
...
//         snippet:
//           "An Immortal reduces the amount of shock it loses when soaking wounds by ½ Rank.",
//       },
//     ],
//     wargearString: "Heavy plating, Gauss blaster or Tesla carbine",
//     wargear: [
//       { name: "Heavy plating" },
//       {
//         name: "Gauss blaster or Tesla carbine",
//         options: [{ name: "Gauss blaster" }, { name: "Tesla carbine" }],
//       },
//     ],
//   },
//   {
...
//         snippet:
//           "You add +½ Rank bonus dice to Attack Tests against organic targets. You suffer +2 DN to Social Tests with non-Destroyer Necrons.",
//         description:
...
//       },
//     ],
//     wargearString: "Heavy plating, Gauss Cannon, Grav-platform",
//     wargear: [
//       { name: "Heavy plating" },
//       { name: "Gauss Cannon" },
//       { name: "Grav-platform" },
...
//       },
//     ],
//     wargearString: "Staff of Light",
//     wargear: [{ name: "Staff of Light" }],
//   },
//   {
//     ...archetype(
//       source.lotn.key,
...
//         snippet:
//           "The character is an embodiment of the Lex Imperialis itself, bringing fear and terror to those bound by its laws. Add +Rank to Intimidation tests against any with the <Imperium> keywords.",
//       },
//     ],
//     wargearString:
//       "Carapace armor, " +
...
//         options: [{ name: "Bolt Pistol" }, { name: "Riot Shield" }],
//       },
//       { name: "Shock Maul" },
//       { name: "Book of Law" },
//       { name: "Manacles" },
...
//         options: [{ name: "Pack of loh-sticks" }, { name: "flask of amasec" }],
//       },
//     ],
//   },
//   {
...
//         snippet:
//           "The character is an embodiment of the Lex Imperialis itself, bringing fear and terror to those bound by its laws. They gain +½ Rank to Resolve and Corruption Tests, and add +Rank to Intimidation tests against any with the <Imperium> keyword.",
//       },
//     ],
//     wargearString:
//       "Carapace armor, " +
...
//         snippet:
//           "Veteran of a hundred gun battles, summary executions and black operations, a Mortiurge has learned to stay alive regardless of the odds when the bullets and las-bolts fly by, using them environment to their best advantage. They are immune to pinning from personal small arms excluding weapons with the Heavy (x) trait. Additionally, they add +1 to the defensive value of any cover except when ambushed in combat.",
//       },
//     ],
//     wargearString:
...
//         options: [{ name: "Bolt Pistol" }, { name: "Needle Pistol" }],
//       },
//       {
//         name: "Sniper Rifle or Needle Rifle",
//         options: [{ name: "Sniper Rifle" }, { name: "Needle Rifle" }],
//       },
//       { name: "Arbites Carapace" },
...
//         snippet:
//           "The character is an embodiment of the Lex Imperialis itself, bringing fear and terror to those bound by its laws. They gain +½ Rank to Corruption Tests and add +Rank to Intimidation and Resolve tests against any with the <Imperium> keywords.",
//       },
//       {
//         name: "Psi-Marshal",
//         snippet:
//           "Arbites Psi-Marshals are rare solitary figures, held at bay by their own men as much as the citizenry. Each precinct-house will have a single Psi-Marshal assigned under ideal conditions to lend their unique talents to the Arbites law-enforcement efforts. Adeptus Arbites Marshals who ascend with the Psychic Revelations package gain access to the Judicium psychic discipline.",
//       },
//     ],
//     wargearString:
//       "Carapace armor, " +
...
//         options: [{ name: "Combat Shotgun" }, { name: "Bolt Pistol" }],
//       },
//       { name: "Power Maul" },
//       { name: "Book of Law" },
//       { name: "Manacles" },
...
//         snippet:
//           "The character is the very embodiment of imperial law and retribution, striking fear to recidivists and heretics alike.. Add +Rank to Intimidation, Resolve, and Corruption tests against any with the <Imperium> and <Chaos> keywords.",
//       },
//     ],
//     wargearString:
...
//         options: [{ name: "Combat Shotgun" }, { name: "Boltgun" }],
//       },
//       {
//         name: "Power Maul or Shock Maul",
//         options: [{ name: "Power Mail" }, { name: "Shock Maul" }],
//       },
//       { name: "Book of Law" },
//       { name: "Manacles" },
//       {
//         name: "Grapplehawk or Patrol Bike",
//         options: [{ name: "Grapplehawk" }, { name: "Ptarol Bike" }],
//       },
//       { name: "Cyber-mastiff" },
//       { name: "Arbitrator ID" },
//       { name: "Chrono" },
...
//         name: "Eager to kill",
//         snippet:
//           "Once per combat, a Juve can add +Rank to a single Action. They also gain a +½ Rank bonus to Resolve tests in combat.",
//       },
//     ],
//     wargearString:
...
//         options: [{ name: "Hive leathers" }, { name: "outlandish attire" }],
//       },
//       { name: "Stubber" },
//       {
...
//         name: "Hab-wise",
//         snippet:
//           "Gangers are accustomed to the deadly environs of the underhives. They gain +Rank to Cunning and Insight tests when interacting with underworld or similar characters.",
//       },
//     ],
//     wargearString:
//       "Hive leathers or outlandish attire, " +
...
//         name: "Pure muscle",
//         snippet:
//           "Heavies are capable of shouldering many weapons other gangers find difficult to wield properly. They gain +Rank when determining their Strength for the Heavy weapon trait. Additionally, they gain +½ Rank damage to their melee attacks.",
//       },
//     ],
//     wargearString:
...
//         snippet:
//           "The gang leaders are often the biggest (next to the heavies) and the baddest member of his crew. The gang leader gains +Rank bonus to his Gang Skill. During a combat, he also gains +½ Rank bonus to his Resolve tests",
//       },
//     ],
//     wargearString:
...
//         options: [{ name: "Outlandish garb" }, { name: "outlandish attire" }],
//       },
//       {
//         name: "flak armor or carapace armor",
//         options: [{ name: "Flak Armour" }, { name: "Carapace Armour" }],
//       },
//       {
...
//         snippet:
//           "Navis Scions begin play without an initial mutation. Additionally, they gain a +½ Rank bonus to Persuasion skill tests.",
//       },
//     ],
//     // new
//     wargearString:
//       "Staff, Mesh Armour, nobilite robes, charm (silk headscarf), flask of amasec",
//     wargear: [
//       { name: "Staff" },
//       { name: "Mesh Armour" },
...
//     ],
//     wargearString:
//       "Laspistol, staff, nobilite robes or imperial robes, charm (silk headscarf) or micro-bead, gene-coded slate monitron.",
//     wargear: [
//       { name: "Laspistol" },
//       { name: "Staff" },
//       {
//         name: "Nobilite Robes or Imperial Robes",
//         options: [{ name: "Nobilite Robes" }, { name: "Imperial Robes" }],
//       },
//       {
...
//         name: "Warp Guide",
//         snippet:
//           "The Navigator Primaris gains +Rank bonus dice to Pilot skill tests when steering a voidship through the Warp. Additionally, he gains +½ Rank to Conviction tests.",
//       },
//     ],
//     wargearString:
...
//         options: [{ name: "Dueling Laspistol" }, { name: "Hand Cannon" }],
//       },
//       { name: "Staff" },
//       { name: "Mesh Armour" },
...
//         options: [{ name: "Digi Weapon" }, { name: "Inferno Pistol" }],
//       },
//       { name: "Staff" },
//       { name: "Mesh Armour" },
//       { name: "Emperor`s tarot deck" },
...
//         snippet:
//           "As Heir-Apparents are inexorably drawn to each, their power waxes in preparation of contending to become the next Paternova. Heir-Apparents gains a chosen Navigator Mutation with each Rank and also gain +Rank when utilizing his Lidless Stare power.",
//       },
//     ],
//     wargearString:
...
//         options: [{ name: "Hotshot Laspistol" }, { name: "Hand Cannon" }],
//       },
//       { name: "Staff" },
//       {
//         name: "Mesh Armour or Carapace",
//         options: [{ name: "Mesh Armour" }, { name: "Carapace Armour" }],
//       },
//       { name: "Emperor`s tarot deck" },
//       { name: "Nobilite Robes" },
//       { name: "Charm", variant: "Silk headscarf" }, // possession
...
//         name: "Soulless Aura",
//         snippet:
//           "All Characters within the Untouchables Willpower x ½ Rank meters suffer a +Rank DN increase to all Social skill test. Characters with the [Eldar] or [Psyker] keyword suffer a single point of Shock for every Round they remain within this area of effect.",
//         description:
...
//         options: [{ name: "Sword" }, { name: "Mace" }, { name: "Autogun" }],
//       },
//       {
//         name: "null-limiter or Flak Armour",
//         options: [{ name: "Null-Limiter" }, { name: "Flak Armour" }],
//       },
//     ],
//   },
//   {
...
//         options: [{ name: "Laspistol" }, { name: "Autopistol" }],
//       },
//       {
//         name: "null-limiter or Flak Armour",
//         options: [{ name: "Null-Limiter" }, { name: "Flak Armour" }],
...
//         options: [{ name: "Boltgun" }, { name: "Bolt Pistol and Chainsword" }],
//       },
//       { name: "Null-Limiter" },
//     ],
//   },
...
//         name: "Guiding Hand",
//         snippet:
//           "Kroot subordinates gain a Kroot mutation and you add +Rank to Leadership, Insight, Cunning, Deception and Medicae with KROOT.",
//         description:
...
//             modifier: 0,
//             rank: 1,
//             condition: "when dealing with KROOT",
//           },
//           {
//             targetGroup: "skills",
//             targetValue: SKILLS.INSIGHT,
//             modifier: 0,
//             rank: 1,
//             condition: "when dealing with KROOT",
//           },
...
//         name: "Psyker",
//         snippet:
//           "You know the Smite psychic power. You may purchase additional psychic powers, following the rules in Chapter 11.",
//         description:
...
//           },
//         ],
//         psychicDisciplines: ["Universal", "Divination"],
//       },
//       {
//         name: "Additional Mutation",
//         snippet:
//           "You gain one additional mutation as your Tier usually allows.",
//         selected: [""],
//         options: [
//           {
